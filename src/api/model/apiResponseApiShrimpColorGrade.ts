...
export interface ApiResponseApiShrimpColorGrade { 
    /**
     * Response status. OK for successful reponses.
     */
    status: ApiResponseApiShrimpColorGrade.StatusEnum;
    /**
     * Simple message to explain client developers the reason for error.
     */
    errorMessage?: string;
    data?: ApiShrimpColorGrade;
    /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiShrimpColorGrade.
 */
export namespace ApiResponseApiShrimpColorGrade {
    /**
     * All properties of ApiResponseApiShrimpColorGrade.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseApiShrimpColorGrade',
            vars: [
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseApiShrimpColorGrade.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseApiShrimpColorGrade',
                    dataType: 'string',
  ...
  // export const ApiResponseApiShrimpColorGradeValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiShrimpColorGrade>;
