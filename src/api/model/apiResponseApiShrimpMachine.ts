...
export interface ApiResponseApiShrimpMachine { 
    /**
     * Response status. OK for successful reponses.
     */
    status: ApiResponseApiShrimpMachine.StatusEnum;
    /**
     * Simple message to explain client developers the reason for error.
     */
    errorMessage?: string;
    data?: ApiShrimpMachine;
    /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiShrimpMachine.
 */
export namespace ApiResponseApiShrimpMachine {
    /**
     * All properties of ApiResponseApiShrimpMachine.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseApiShrimpMachine',
            vars: [
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseApiShrimpMachine.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseApiShrimpMachine',
                    dataType: 'string',
  ...
  // export const ApiResponseApiShrimpMachineValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiShrimpMachine>;
