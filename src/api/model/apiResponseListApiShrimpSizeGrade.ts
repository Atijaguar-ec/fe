...
import { ApiShrimpSizeGrade } from './apiShrimpSizeGrade';
...
export interface ApiResponseListApiShrimpSizeGrade { 
    /**
     * Response status. OK for successful reponses.
     */
    status: ApiResponseListApiShrimpSizeGrade.StatusEnum;
    /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseListApiShrimpSizeGrade.
 */
export namespace ApiResponseListApiShrimpSizeGrade {
    /**
     * All properties of ApiResponseListApiShrimpSizeGrade.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseListApiShrimpSizeGrade',
            vars: [
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseListApiShrimpSizeGrade.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseListApiShrimpSizeGrade',
                    dataType: 'string',
                ...
                {
                    metadata: ApiShrimpSizeGrade.formMetadata,
                    isReadOnly: false,
                    isEnum: false,
                    required: false,
                    name: 'data',
                    classname: 'ApiResponseListApiShrimpSizeGrade',
                    dataType: 'Array&lt;ApiShrimpSizeGrade&gt;',
                    isPrimitiveType: false,
                    isListContainer: true,
                    complexType: 'ApiShrimpSizeGrade'
                },
                {
                    isReadOnly: false,
                    isEnum: false,
  ...
  // export const ApiResponseListApiShrimpSizeGradeValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseListApiShrimpSizeGrade>;
