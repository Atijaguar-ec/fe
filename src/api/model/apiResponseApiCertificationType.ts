...
export interface ApiResponseApiCertificationType { 
    /**
     * Response status. OK for successful reponses.
     */
    status: ApiResponseApiCertificationType.StatusEnum;
    /**
     * Simple message to explain client developers the reason for error.
     */
    errorMessage?: string;
    data?: ApiCertificationType;
    /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiCertificationType.
 */
export namespace ApiResponseApiCertificationType {
    /**
     * All properties of ApiResponseApiCertificationType.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseApiCertificationType',
            vars: [
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseApiCertificationType.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseApiCertificationType',
                    dataType: 'string',
  ...
  // export const ApiResponseApiCertificationTypeValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiCertificationType>;
