...
export interface ApiResponseApiShrimpBrand { 
    /**
     * Response status. OK for successful reponses.
     */
    status: ApiResponseApiShrimpBrand.StatusEnum;
    /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiShrimpBrand.
 */
export namespace ApiResponseApiShrimpBrand {
    /**
     * All properties of ApiResponseApiShrimpBrand.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseApiShrimpBrand',
            vars: [
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseApiShrimpBrand.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseApiShrimpBrand',
                    dataType: 'string',
  ...
  // export const ApiResponseApiShrimpBrandValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiShrimpBrand>;
