...
export interface ApiResponseApiShrimpSizeGrade { 
    /**
     * Response status. OK for successful reponses.
     */
    status: ApiResponseApiShrimpSizeGrade.StatusEnum;
    /**
     * Simple message to explain client developers the reason for error.
     */
    errorMessage?: string;
    data?: ApiShrimpSizeGrade;
    /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiShrimpSizeGrade.
 */
export namespace ApiResponseApiShrimpSizeGrade {
    /**
     * All properties of ApiResponseApiShrimpSizeGrade.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseApiShrimpSizeGrade',
            vars: [
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseApiShrimpSizeGrade.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseApiShrimpSizeGrade',
                    dataType: 'string',
  ...
  // export const ApiResponseApiShrimpSizeGradeValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiShrimpSizeGrade>;
