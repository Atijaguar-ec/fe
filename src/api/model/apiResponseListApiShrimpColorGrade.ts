...
import { ApiShrimpColorGrade } from './apiShrimpColorGrade';
...
export interface ApiResponseListApiShrimpColorGrade { 
    /**
     * Response status. OK for successful reponses.
     */
    status: ApiResponseListApiShrimpColorGrade.StatusEnum;
    /**
     ...
     */
    data?: Array<ApiShrimpColorGrade>;
    /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseListApiShrimpColorGrade.
 */
export namespace ApiResponseListApiShrimpColorGrade {
    /**
     * All properties of ApiResponseListApiShrimpColorGrade.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseListApiShrimpColorGrade',
            vars: [
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseListApiShrimpColorGrade.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseListApiShrimpColorGrade',
                    dataType: 'string',
                ...
                {
                    metadata: ApiShrimpColorGrade.formMetadata,
                    isReadOnly: false,
                    isEnum: false,
                    required: false,
                    name: 'data',
                    classname: 'ApiResponseListApiShrimpColorGrade',
                    dataType: 'Array&lt;ApiShrimpColorGrade&gt;',
                    isPrimitiveType: false,
                    isListContainer: true,
                    complexType: 'ApiShrimpColorGrade'
                },
                {
                    isReadOnly: false,
                    isEnum: false,
  ...
  // export const ApiResponseListApiShrimpColorGradeValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseListApiShrimpColorGrade>;
