...
export interface ApiResponseApiShrimpProcessType { 
    /**
     * Response status. OK for successful reponses.
     */
    status: ApiResponseApiShrimpProcessType.StatusEnum;
    /**
     * Simple message to explain client developers the reason for error.
     */
    errorMessage?: string;
    data?: ApiShrimpProcessType;
    /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiShrimpProcessType.
 */
export namespace ApiResponseApiShrimpProcessType {
    /**
     * All properties of ApiResponseApiShrimpProcessType.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseApiShrimpProcessType',
            vars: [
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseApiShrimpProcessType.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseApiShrimpProcessType',
                    dataType: 'string',
  ...
  // export const ApiResponseApiShrimpProcessTypeValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiShrimpProcessType>;
