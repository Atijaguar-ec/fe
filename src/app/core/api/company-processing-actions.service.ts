...
export class CompanyProcessingActionsService {
   ...
   */
  updateCompanyProcessingAction(companyId: number, processingActionId: number, 
                               config: ApiCompanyProcessingAction, language: string = 'EN'): Observable<{data: ApiCompanyProcessingAction}> {
