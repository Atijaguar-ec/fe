...
import { ApiDeliveriesTotal } from './apiDeliveriesTotal';
...
export interface ApiResponseApiDeliveriesTotal {
  /**
   * Response status. OK for successful reponses.
   */
  status: ApiResponseApiDeliveriesTotal.StatusEnum;
  /**
   * Simple message to explain client developers the reason for error.
   */
  errorMessage?: string;
  data?: ApiDeliveriesTotal;
  /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiDeliveriesTotal.
 */
export namespace ApiResponseApiDeliveriesTotal {
  /**
   * All properties of ApiResponseApiDeliveriesTotal.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiDeliveriesTotal',
      vars: [
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiDeliveriesTotal.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiDeliveriesTotal',
          dataType: 'string',
        ...
        {
          metadata: ApiDeliveriesTotal.formMetadata,
          isReadOnly: false,
          isEnum: false,
          required: false,
          name: 'data',
          classname: 'ApiResponseApiDeliveriesTotal',
          dataType: 'ApiDeliveriesTotal',
          isPrimitiveType: false,
          isListContainer: false,
          complexType: 'ApiDeliveriesTotal',
        },
        {
          isReadOnly: false,
          isEnum: false,
  ...
  // export const ApiResponseApiDeliveriesTotalValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiDeliveriesTotal>;
}
