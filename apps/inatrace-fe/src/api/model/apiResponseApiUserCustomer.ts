...
export interface ApiResponseApiUserCustomer {
  /**
   * Response status. OK for successful reponses.
   */
  status: ApiResponseApiUserCustomer.StatusEnum;
  /**
   * Simple message to explain client developers the reason for error.
   */
  errorMessage?: string;
  data?: ApiUserCustomer;
  /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiUserCustomer.
 */
export namespace ApiResponseApiUserCustomer {
  /**
   * All properties of ApiResponseApiUserCustomer.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiUserCustomer',
      vars: [
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiUserCustomer.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiUserCustomer',
          dataType: 'string',
  ...
  // export const ApiResponseApiUserCustomerValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiUserCustomer>;
}
