...
import { ApiBeycoOrderFields } from './apiBeycoOrderFields';
...
export interface ApiResponseApiBeycoOrderFields {
  /**
   * Response status. OK for successful reponses.
   */
  status: ApiResponseApiBeycoOrderFields.StatusEnum;
  /**
   * Simple message to explain client developers the reason for error.
   */
  errorMessage?: string;
  data?: ApiBeycoOrderFields;
  /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiBeycoOrderFields.
 */
export namespace ApiResponseApiBeycoOrderFields {
  /**
   * All properties of ApiResponseApiBeycoOrderFields.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiBeycoOrderFields',
      vars: [
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiBeycoOrderFields.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiBeycoOrderFields',
          dataType: 'string',
        ...
        {
          metadata: ApiBeycoOrderFields.formMetadata,
          isReadOnly: false,
          isEnum: false,
          required: false,
          name: 'data',
          classname: 'ApiResponseApiBeycoOrderFields',
          dataType: 'ApiBeycoOrderFields',
          isPrimitiveType: false,
          isListContainer: false,
          complexType: 'ApiBeycoOrderFields',
        },
        {
          isReadOnly: false,
          isEnum: false,
  ...
  // export const ApiResponseApiBeycoOrderFieldsValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiBeycoOrderFields>;
}
