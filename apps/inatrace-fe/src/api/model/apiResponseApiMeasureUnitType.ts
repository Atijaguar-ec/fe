...
export interface ApiResponseApiMeasureUnitType {
  /**
   * Response status. OK for successful reponses.
   */
  status: ApiResponseApiMeasureUnitType.StatusEnum;
  /**
   * Simple message to explain client developers the reason for error.
   */
  errorMessage?: string;
  data?: ApiMeasureUnitType;
  /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiMeasureUnitType.
 */
export namespace ApiResponseApiMeasureUnitType {
  /**
   * All properties of ApiResponseApiMeasureUnitType.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiMeasureUnitType',
      vars: [
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiMeasureUnitType.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiMeasureUnitType',
          dataType: 'string',
  ...
  // export const ApiResponseApiMeasureUnitTypeValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiMeasureUnitType>;
}
