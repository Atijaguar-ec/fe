...
export interface ApiResponseListApiShrimpBrand { 
    /**
     * Response status. OK for successful reponses.
     */
    status: ApiResponseListApiShrimpBrand.StatusEnum;
    /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseListApiShrimpBrand.
 */
export namespace ApiResponseListApiShrimpBrand {
    /**
     * All properties of ApiResponseListApiShrimpBrand.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseListApiShrimpBrand',
            vars: [
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseListApiShrimpBrand.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseListApiShrimpBrand',
                    dataType: 'string',
  ...
  // export const ApiResponseListApiShrimpBrandValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseListApiShrimpBrand>;
