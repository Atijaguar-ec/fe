...
import { ApiQRTagPublic } from './apiQRTagPublic';
...
export interface ApiResponseApiQRTagPublic {
  /**
   * Response status. OK for successful reponses.
   */
  status: ApiResponseApiQRTagPublic.StatusEnum;
  /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiQRTagPublic.
 */
export namespace ApiResponseApiQRTagPublic {
  /**
   * All properties of ApiResponseApiQRTagPublic.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiQRTagPublic',
      vars: [
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiQRTagPublic.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiQRTagPublic',
          dataType: 'string',
        ...
        {
          metadata: ApiQRTagPublic.formMetadata,
          isReadOnly: false,
          isEnum: false,
          required: false,
          name: 'data',
          classname: 'ApiResponseApiQRTagPublic',
          dataType: 'ApiQRTagPublic',
          isPrimitiveType: false,
          isListContainer: false,
          complexType: 'ApiQRTagPublic',
        },
        {
          isReadOnly: false,
          isEnum: false,
  ...
  // export const ApiResponseApiQRTagPublicValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiQRTagPublic>;
}
