...
export interface ApiResponseApiFacilityType {
  /**
   * Response status. OK for successful reponses.
   */
  status: ApiResponseApiFacilityType.StatusEnum;
  /**
   * Simple message to explain client developers the reason for error.
   */
  errorMessage?: string;
  data?: ApiFacilityType;
  /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiFacilityType.
 */
export namespace ApiResponseApiFacilityType {
  /**
   * All properties of ApiResponseApiFacilityType.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiFacilityType',
      vars: [
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiFacilityType.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiFacilityType',
          dataType: 'string',
  ...
  // export const ApiResponseApiFacilityTypeValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiFacilityType>;
}
