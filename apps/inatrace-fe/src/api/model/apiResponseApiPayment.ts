...
export interface ApiResponseApiPayment {
  /**
   * Response status. OK for successful reponses.
   */
  status: ApiResponseApiPayment.StatusEnum;
  /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiPayment.
 */
export namespace ApiResponseApiPayment {
  /**
   * All properties of ApiResponseApiPayment.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiPayment',
      vars: [
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiPayment.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiPayment',
          dataType: 'string',
  ...
  // export const ApiResponseApiPaymentValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiPayment>;
}
