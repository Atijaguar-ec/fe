...
import { ApiStockOrderPublic } from './apiStockOrderPublic';
...
export interface ApiResponseApiStockOrderPublic {
  data?: ApiStockOrderPublic;
  /**
   ...
   */
  status: ApiResponseApiStockOrderPublic.StatusEnum;
  validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiStockOrderPublic.
 */
export namespace ApiResponseApiStockOrderPublic {
  /**
   * All properties of ApiResponseApiStockOrderPublic.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiStockOrderPublic',
      vars: [
        {
          metadata: ApiStockOrderPublic.formMetadata,
          isReadOnly: false,
          isEnum: false,
          required: false,
          name: 'data',
          classname: 'ApiResponseApiStockOrderPublic',
          dataType: 'ApiStockOrderPublic',
          isPrimitiveType: false,
          isListContainer: false,
          complexType: 'ApiStockOrderPublic',
        },
        {
          isReadOnly: false,
          isEnum: false,
        ...
        },
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiStockOrderPublic.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiStockOrderPublic',
          dataType: 'string',
  ...
  // export const ApiResponseApiStockOrderPublicValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiStockOrderPublic>;
}
