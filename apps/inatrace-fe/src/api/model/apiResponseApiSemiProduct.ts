...
export interface ApiResponseApiSemiProduct {
  /**
   * Response status. OK for successful reponses.
   */
  status: ApiResponseApiSemiProduct.StatusEnum;
  /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiSemiProduct.
 */
export namespace ApiResponseApiSemiProduct {
  /**
   * All properties of ApiResponseApiSemiProduct.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiSemiProduct',
      vars: [
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiSemiProduct.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiSemiProduct',
          dataType: 'string',
  ...
  // export const ApiResponseApiSemiProductValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiSemiProduct>;
}
