...
export interface ApiResponseApiDocument {
   ...
   */
  status: ApiResponseApiDocument.StatusEnum;
  /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiDocument.
 */
export namespace ApiResponseApiDocument {
  /**
   * All properties of ApiResponseApiDocument.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiDocument',
      vars: [
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiDocument.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiDocument',
          dataType: 'string',
  ...
  // export const ApiResponseApiDocumentValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiDocument>;
}
