...
import { ApiCompanyPublic } from './apiCompanyPublic';
...
export interface ApiResponseApiCompanyPublic {
  data?: ApiCompanyPublic;
  /**
   ...
   */
  status: ApiResponseApiCompanyPublic.StatusEnum;
  validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiCompanyPublic.
 */
export namespace ApiResponseApiCompanyPublic {
  /**
   * All properties of ApiResponseApiCompanyPublic.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiCompanyPublic',
      vars: [
        {
          metadata: ApiCompanyPublic.formMetadata,
          isReadOnly: false,
          isEnum: false,
          required: false,
          name: 'data',
          classname: 'ApiResponseApiCompanyPublic',
          dataType: 'ApiCompanyPublic',
          isPrimitiveType: false,
          isListContainer: false,
          complexType: 'ApiCompanyPublic',
        },
        {
          isReadOnly: false,
          isEnum: false,
        ...
        },
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiCompanyPublic.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiCompanyPublic',
          dataType: 'string',
  ...
  // export const ApiResponseApiCompanyPublicValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiCompanyPublic>;
}
