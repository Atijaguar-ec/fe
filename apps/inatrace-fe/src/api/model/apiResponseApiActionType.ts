...
export interface ApiResponseApiActionType {
  data?: ApiActionType;
  /**
   ...
   */
  status: ApiResponseApiActionType.StatusEnum;
  validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiActionType.
 */
export namespace ApiResponseApiActionType {
  /**
   * All properties of ApiResponseApiActionType.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiActionType',
      vars: [
        {
        ...
        },
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiActionType.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiActionType',
          dataType: 'string',
  ...
  // export const ApiResponseApiActionTypeValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiActionType>;
}
