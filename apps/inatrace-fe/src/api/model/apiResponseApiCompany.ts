...
export interface ApiResponseApiCompany {
   ...
   */
  status: ApiResponseApiCompany.StatusEnum;
  validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiCompany.
 */
export namespace ApiResponseApiCompany {
  /**
   * All properties of ApiResponseApiCompany.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiCompany',
      vars: [
        {
        ...
        },
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiCompany.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiCompany',
          dataType: 'string',
  ...
  // export const ApiResponseApiCompanyValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiCompany>;
}
