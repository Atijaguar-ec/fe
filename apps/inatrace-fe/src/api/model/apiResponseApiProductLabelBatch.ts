...
export interface ApiResponseApiProductLabelBatch {
   ...
   */
  status: ApiResponseApiProductLabelBatch.StatusEnum;
  /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiProductLabelBatch.
 */
export namespace ApiResponseApiProductLabelBatch {
  /**
   * All properties of ApiResponseApiProductLabelBatch.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiProductLabelBatch',
      vars: [
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiProductLabelBatch.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiProductLabelBatch',
          dataType: 'string',
  ...
  // export const ApiResponseApiProductLabelBatchValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiProductLabelBatch>;
}
