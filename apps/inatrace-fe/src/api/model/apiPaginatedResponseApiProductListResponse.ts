...
/**
 * Namespace for property- and property-value-enumerations of ApiPaginatedResponseApiProductListResponse.
 */
export namespace ApiPaginatedResponseApiProductListResponse {
  /**
      ...
      vars: [
        {
          ...
          isEnum: true,
          datatypeWithEnum:
            'ApiPaginatedResponseApiProductListResponse.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiPaginatedResponseApiProductListResponse',
          dataType: 'string',
        ...
        },
        {
          ...
          name: 'data',
          classname: 'ApiPaginatedResponseApiProductListResponse',
          dataType: 'ApiPaginatedListApiProductListResponse',
          isPrimitiveType: false,
          isListContainer: false,
          complexType: 'ApiPaginatedListApiProductListResponse',
        },
        {
          isReadOnly: false,
          isEnum: false,
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiPaginatedResponseApiProductListResponse>;
}
