...
export interface ApiResponseApiBulkPayment {
  /**
   * Response status. OK for successful reponses.
   */
  status: ApiResponseApiBulkPayment.StatusEnum;
  /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiBulkPayment.
 */
export namespace ApiResponseApiBulkPayment {
  /**
   * All properties of ApiResponseApiBulkPayment.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiBulkPayment',
      vars: [
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiBulkPayment.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiBulkPayment',
          dataType: 'string',
  ...
  // export const ApiResponseApiBulkPaymentValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiBulkPayment>;
}
