...
export interface ApiResponseApiFacility {
  /**
   * Response status. OK for successful reponses.
   */
  status: ApiResponseApiFacility.StatusEnum;
  /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiFacility.
 */
export namespace ApiResponseApiFacility {
  /**
   * All properties of ApiResponseApiFacility.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiFacility',
      vars: [
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiFacility.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiFacility',
          dataType: 'string',
  ...
  // export const ApiResponseApiFacilityValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiFacility>;
}
