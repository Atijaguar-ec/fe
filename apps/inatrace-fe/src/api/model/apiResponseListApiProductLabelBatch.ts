...
export interface ApiResponseListApiProductLabelBatch {
   ...
   */
  data?: Array<ApiProductLabelBatch>;
  /**
   ...
   */
  status: ApiResponseListApiProductLabelBatch.StatusEnum;
  validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseListApiProductLabelBatch.
 */
export namespace ApiResponseListApiProductLabelBatch {
  /**
   * All properties of ApiResponseListApiProductLabelBatch.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseListApiProductLabelBatch',
      vars: [
        {
        ...
        },
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseListApiProductLabelBatch.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseListApiProductLabelBatch',
          dataType: 'string',
  ...
  // export const ApiResponseListApiProductLabelBatchValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseListApiProductLabelBatch>;
}
