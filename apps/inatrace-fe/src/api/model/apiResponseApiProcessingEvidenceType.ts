...
export interface ApiResponseApiProcessingEvidenceType {
  /**
   * Response status. OK for successful reponses.
   */
  status: ApiResponseApiProcessingEvidenceType.StatusEnum;
  /**
   * Simple message to explain client developers the reason for error.
   */
  errorMessage?: string;
  data?: ApiProcessingEvidenceType;
  /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiProcessingEvidenceType.
 */
export namespace ApiResponseApiProcessingEvidenceType {
  /**
   * All properties of ApiResponseApiProcessingEvidenceType.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiProcessingEvidenceType',
      vars: [
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiProcessingEvidenceType.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiProcessingEvidenceType',
          dataType: 'string',
        ...
        },
        {
          ...
          name: 'data',
          classname: 'ApiResponseApiProcessingEvidenceType',
          dataType: 'ApiProcessingEvidenceType',
  ...
  // export const ApiResponseApiProcessingEvidenceTypeValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiProcessingEvidenceType>;
}
