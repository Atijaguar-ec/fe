...
export interface ApiResponseApiProductOrder {
  /**
   * Response status. OK for successful reponses.
   */
  status: ApiResponseApiProductOrder.StatusEnum;
  /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiProductOrder.
 */
export namespace ApiResponseApiProductOrder {
  /**
   * All properties of ApiResponseApiProductOrder.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiProductOrder',
      vars: [
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiProductOrder.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiProductOrder',
          dataType: 'string',
  ...
  // export const ApiResponseApiProductOrderValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiProductOrder>;
}
