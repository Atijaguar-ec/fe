...
export interface ApiResponseApiProductLabel {
   ...
   */
  status: ApiResponseApiProductLabel.StatusEnum;
  /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiProductLabel.
 */
export namespace ApiResponseApiProductLabel {
  /**
   * All properties of ApiResponseApiProductLabel.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiProductLabel',
      vars: [
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiProductLabel.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiProductLabel',
          dataType: 'string',
        ...
        {
          metadata: ApiProductLabel.formMetadata,
          isReadOnly: false,
          isEnum: false,
          required: false,
          name: 'data',
          classname: 'ApiResponseApiProductLabel',
          dataType: 'ApiProductLabel',
          isPrimitiveType: false,
          isListContainer: false,
          complexType: 'ApiProductLabel',
        },
        {
          isReadOnly: false,
          isEnum: false,
  ...
  // export const ApiResponseApiProductLabelValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiProductLabel>;
}
