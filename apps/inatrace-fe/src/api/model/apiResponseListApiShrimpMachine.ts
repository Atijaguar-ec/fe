...
export interface ApiResponseListApiShrimpMachine { 
    /**
     * Response status. OK for successful reponses.
     */
    status: ApiResponseListApiShrimpMachine.StatusEnum;
    /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseListApiShrimpMachine.
 */
export namespace ApiResponseListApiShrimpMachine {
    /**
     * All properties of ApiResponseListApiShrimpMachine.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseListApiShrimpMachine',
            vars: [
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseListApiShrimpMachine.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseListApiShrimpMachine',
                    dataType: 'string',
  ...
  // export const ApiResponseListApiShrimpMachineValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseListApiShrimpMachine>;
