...
import { ApiKnowledgeBlog } from './apiKnowledgeBlog';
...
export interface ApiResponseApiKnowledgeBlog {
  /**
   * Response status. OK for successful reponses.
   */
  status: ApiResponseApiKnowledgeBlog.StatusEnum;
  /**
   * Simple message to explain client developers the reason for error.
   */
  errorMessage?: string;
  data?: ApiKnowledgeBlog;
  /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiKnowledgeBlog.
 */
export namespace ApiResponseApiKnowledgeBlog {
  /**
   * All properties of ApiResponseApiKnowledgeBlog.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiKnowledgeBlog',
      vars: [
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiKnowledgeBlog.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiKnowledgeBlog',
          dataType: 'string',
        ...
        {
          metadata: ApiKnowledgeBlog.formMetadata,
          isReadOnly: false,
          isEnum: false,
          required: false,
          name: 'data',
          classname: 'ApiResponseApiKnowledgeBlog',
          dataType: 'ApiKnowledgeBlog',
          isPrimitiveType: false,
          isListContainer: false,
          complexType: 'ApiKnowledgeBlog',
        },
        {
          isReadOnly: false,
          isEnum: false,
  ...
  // export const ApiResponseApiKnowledgeBlogValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiKnowledgeBlog>;
}
