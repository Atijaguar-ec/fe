...
export namespace ApiCreateUserRequest {
  ...
  export function formMetadata() {
    return {
      ...
      validators: {
        email: [['required'], ['minlength', 0], ['maxlength', 255]],
        password: [['required'], ['minlength', 0], ['maxlength', 100]],
        name: [['required'], ['minlength', 0], ['maxlength', 255]],
        surname: [['required'], ['minlength', 0], ['maxlength', 255]],
        language: [],
      },
    };
  }
