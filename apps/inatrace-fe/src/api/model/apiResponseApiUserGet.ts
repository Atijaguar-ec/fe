...
export interface ApiResponseApiUserGet {
   ...
   */
  status: ApiResponseApiUserGet.StatusEnum;
  /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiUserGet.
 */
export namespace ApiResponseApiUserGet {
  /**
   * All properties of ApiResponseApiUserGet.
   */
  ...
  export function formMetadata() {
    return {
      ...
      classname: 'ApiResponseApiUserGet',
      vars: [
        {
          isReadOnly: false,
          isEnum: true,
          datatypeWithEnum: 'ApiResponseApiUserGet.StatusEnum',
          required: true,
          name: 'status',
          classname: 'ApiResponseApiUserGet',
          dataType: 'string',
        ...
        {
          metadata: ApiUserGet.formMetadata,
          isReadOnly: false,
          isEnum: false,
          required: false,
          name: 'data',
  ...
  // export const ApiResponseApiUserGetValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiUserGet>;
}
