...
export interface ApiResponseApiFieldInspection { 
    /**
     * Response status. OK for successful reponses.
     */
    status: ApiResponseApiFieldInspection.StatusEnum;
    /**
     * Simple message to explain client developers the reason for error.
     */
    errorMessage?: string;
    data?: ApiFieldInspection;
    /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiFieldInspection.
 */
export namespace ApiResponseApiFieldInspection {
    /**
     * All properties of ApiResponseApiFieldInspection.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseApiFieldInspection',
            vars: [
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseApiFieldInspection.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseApiFieldInspection',
                    dataType: 'string',
  ...
  // export const ApiResponseApiFieldInspectionValidationScheme = {
  //     validators: [],
  //     fields: {
  //               status: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiFieldInspection>;
