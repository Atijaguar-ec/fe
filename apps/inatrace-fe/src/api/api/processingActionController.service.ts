...
export namespace CreateOrUpdateProcessingAction {
  ...
  export const ParamValidators: {
    [K in keyof CreateOrUpdateProcessingAction.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {};
...
export namespace DeleteProcessingAction {
   ...
   */
  export const ParamValidators: {
    [K in keyof DeleteProcessingAction.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export namespace GetProcessingAction {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetProcessingAction.PartialParamMap]?: [string, ValidatorFn][];
  } = {
    id: [['required', Validators.required]],
    language: [],
  };
...
export namespace GetProcessingActionDetail {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetProcessingActionDetail.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export namespace ListProcessingActionsByCompany {
   ...
   */
  export const ParamValidators: {
    [K in keyof ListProcessingActionsByCompany.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export class ProcessingActionControllerService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public createOrUpdateProcessingAction(
    ApiProcessingAction: ApiProcessingAction,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public createOrUpdateProcessingAction(
    ...
    if (ApiProcessingAction === null || ApiProcessingAction === undefined) {
      throw new Error(
        'Required parameter ApiProcessingAction was null or undefined when calling createOrUpdateProcessingAction.',
      );
    }
    ...
    const handle = this.httpClient.put<ApiResponseApiBaseEntity>(
      `${this.configuration.basePath}/api/chain/processing-action`,
      ApiProcessingAction,
      {
      ...
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(
            err,
            'createOrUpdateProcessingAction',
          ),
        ),
      );
    }
  ...
  public deleteProcessingActionByMap(
    ...
    return this.deleteProcessingAction(map.id, observe, reportProgress);
  }
  ...
  public deleteProcessingAction(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling deleteProcessingAction.',
      );
    }
    ...
    const handle = this.httpClient.delete<ApiDefaultResponse>(
      `${this.configuration.basePath}/api/chain/processing-action/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'deleteProcessingAction'),
        ),
      );
    }
    return handle;
  ...
  public getProcessingActionByMap(
    ...
    observe?: 'body',
    reportProgress?: boolean,
  ): Observable<ApiResponseApiProcessingAction>;
  public getProcessingActionByMap(
    map: GetProcessingAction.PartialParamMap,
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiResponseApiProcessingAction>>;
  public getProcessingActionByMap(
    map: GetProcessingAction.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiResponseApiProcessingAction>>;
  public getProcessingActionByMap(
    map: GetProcessingAction.PartialParamMap,
    observe: any = 'body',
    reportProgress: boolean = false,
  ...
  public getProcessingAction(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getProcessingAction.',
      );
    }
    ...
    const handle = this.httpClient.get<ApiResponseApiProcessingAction>(
      `${this.configuration.basePath}/api/chain/processing-action/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getProcessingAction'),
        ),
      );
    }
    return handle;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getProcessingActionDetail(
    id: number,
    language?: 'EN' | 'DE' | 'RW' | 'ES',
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public getProcessingActionDetail(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getProcessingActionDetail.',
      );
    }
    ...
    const handle = this.httpClient.get<ApiResponseApiProcessingAction>(
      `${this.configuration.basePath}/api/chain/processing-action/${encodeURIComponent(String(id))}/detail`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getProcessingActionDetail'),
        ),
      );
    }
    return handle;
  ...
  public listProcessingActionsByCompanyByMap(
    ...
    observe?: 'body',
    reportProgress?: boolean,
  ): Observable<ApiPaginatedResponseApiProcessingAction>;
  public listProcessingActionsByCompanyByMap(
    map: ListProcessingActionsByCompany.PartialParamMap,
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiPaginatedResponseApiProcessingAction>>;
  public listProcessingActionsByCompanyByMap(
    map: ListProcessingActionsByCompany.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiPaginatedResponseApiProcessingAction>>;
  public listProcessingActionsByCompanyByMap(
    map: ListProcessingActionsByCompany.PartialParamMap,
    observe: any = 'body',
    reportProgress: boolean = false,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public listProcessingActionsByCompany(
    id: number,
    actionType?:
      | 'PROCESSING'
      | 'FINAL_PROCESSING'
  ...
  public listProcessingActionsByCompany(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling listProcessingActionsByCompany.',
      );
    }
    ...
    const handle = this.httpClient.get<ApiPaginatedResponseApiProcessingAction>(
      `${this.configuration.basePath}/api/chain/processing-action/list/company/${encodeURIComponent(String(id))}`,
      {
