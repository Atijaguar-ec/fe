...
export namespace DisableCurrency {
  ...
  export const ParamValidators: {
    [K in keyof DisableCurrency.PartialParamMap]?: [string, ValidatorFn][];
  } = {
...
export namespace EnableCurrency {
   ...
   */
  export const ParamValidators: {
    [K in keyof EnableCurrency.PartialParamMap]?: [string, ValidatorFn][];
  } = {
    id: [['required', Validators.required]],
  };
}
...
export namespace GetCurrencyTypes {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetCurrencyTypes.PartialParamMap]?: [string, ValidatorFn][];
  } = {
    query: [],
    requestType: [],
...
export namespace GetDisabledCurrencyTypes {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetDisabledCurrencyTypes.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export namespace GetEnabledCurrencyTypes {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetEnabledCurrencyTypes.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export class CurrencyTypeControllerService {
  ...
  public disableCurrencyByMap(
    ...
    return this.disableCurrency(map.id, observe, reportProgress);
  }
  ...
  public disableCurrency(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling disableCurrency.',
      );
    }
    ...
    const handle = this.httpClient.put<ApiDefaultResponse>(
      `${this.configuration.basePath}/api/chain/currency-type/${encodeURIComponent(String(id))}/disable`,
      null,
      {
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'disableCurrency'),
        ),
      );
    }
    return handle;
  ...
  public enableCurrencyByMap(
    ...
    return this.enableCurrency(map.id, observe, reportProgress);
  }
  ...
  public enableCurrency(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling enableCurrency.',
      );
    }
    ...
    const handle = this.httpClient.put<ApiDefaultResponse>(
      `${this.configuration.basePath}/api/chain/currency-type/${encodeURIComponent(String(id))}/enable`,
      null,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'enableCurrency'),
        ),
      );
    }
    return handle;
  ...
  public getCurrencyTypesByMap(
    ...
    observe?: 'body',
    reportProgress?: boolean,
  ): Observable<ApiPaginatedResponseApiCurrencyType>;
  public getCurrencyTypesByMap(
    map: GetCurrencyTypes.PartialParamMap,
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiPaginatedResponseApiCurrencyType>>;
  public getCurrencyTypesByMap(
    map: GetCurrencyTypes.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiPaginatedResponseApiCurrencyType>>;
  public getCurrencyTypesByMap(
    map: GetCurrencyTypes.PartialParamMap,
    observe: any = 'body',
    reportProgress: boolean = false,
  ...
  public getCurrencyTypes(
    ...
    const handle = this.httpClient.get<ApiPaginatedResponseApiCurrencyType>(
      `${this.configuration.basePath}/api/chain/currency-type/list`,
      {
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getCurrencyTypes'),
        ),
      );
    }
    return handle;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getDisabledCurrencyTypes(
    query?: string,
    requestType?: 'COUNT' | 'FETCH',
    limit?: number,
    offset?: number,
  ...
  public getDisabledCurrencyTypes(
    ...
    const handle = this.httpClient.get<ApiPaginatedResponseApiCurrencyType>(
      `${this.configuration.basePath}/api/chain/currency-type/list/disabled`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getDisabledCurrencyTypes'),
        ),
      );
    }
    return handle;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getEnabledCurrencyTypes(
    query?: string,
    requestType?: 'COUNT' | 'FETCH',
    limit?: number,
    offset?: number,
  ...
  public getEnabledCurrencyTypes(
    ...
    const handle = this.httpClient.get<ApiPaginatedResponseApiCurrencyType>(
      `${this.configuration.basePath}/api/chain/currency-type/list/enabled`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getEnabledCurrencyTypes'),
        ),
      );
    }
    return handle;
