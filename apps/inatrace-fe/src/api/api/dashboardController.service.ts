...
export namespace CalculateProcessingPerformanceData {
  ...
  export const ParamValidators: {
    [K in keyof CalculateProcessingPerformanceData.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {};
...
export namespace ExportDeliveriesData {
   ...
   */
  export const ParamValidators: {
    [K in keyof ExportDeliveriesData.PartialParamMap]?: [string, ValidatorFn][];
  } = {
    companyId: [['required', Validators.required]],
    aggregationType: [['required', Validators.required]],
    exportType: [['required', Validators.required]],
    facilityIds: [],
    semiProductId: [],
    farmerId: [],
    collectorId: [],
...
export namespace ExportProcessingPerformanceData {
   ...
   */
  export const ParamValidators: {
    [K in keyof ExportProcessingPerformanceData.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export namespace GetDeliveriesAggregatedData {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetDeliveriesAggregatedData.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export class DashboardControllerService {
  ...
  ): Observable<ApiResponseApiProcessingPerformanceTotal>;
  public calculateProcessingPerformanceDataByMap(
    map: CalculateProcessingPerformanceData.PartialParamMap,
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiResponseApiProcessingPerformanceTotal>>;
  public calculateProcessingPerformanceDataByMap(
    map: CalculateProcessingPerformanceData.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiResponseApiProcessingPerformanceTotal>>;
  public calculateProcessingPerformanceDataByMap(
    map: CalculateProcessingPerformanceData.PartialParamMap,
    observe: any = 'body',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public calculateProcessingPerformanceData(
    ApiProcessingPerformanceRequest: ApiProcessingPerformanceRequest,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public calculateProcessingPerformanceData(
    ...
    if (
      ApiProcessingPerformanceRequest === null ||
      ApiProcessingPerformanceRequest === undefined
    ) {
      throw new Error(
        'Required parameter ApiProcessingPerformanceRequest was null or undefined when calling calculateProcessingPerformanceData.',
      );
    }
    ...
    const handle =
      this.httpClient.post<ApiResponseApiProcessingPerformanceTotal>(
        `${this.configuration.basePath}/api/dashboard/processing-performance-data`,
  ...
  public exportDeliveriesData(
    ...
    if (companyId === null || companyId === undefined) {
      throw new Error(
        'Required parameter companyId was null or undefined when calling exportDeliveriesData.',
      );
    }
    if (aggregationType === null || aggregationType === undefined) {
      throw new Error(
        'Required parameter aggregationType was null or undefined when calling exportDeliveriesData.',
      );
    }
    if (exportType === null || exportType === undefined) {
      throw new Error(
        'Required parameter exportType was null or undefined when calling exportDeliveriesData.',
      );
    }
    ...
    const handle = this.httpClient.get(
      `${this.configuration.basePath}/api/dashboard/deliveries-aggregated-data/export`,
      {
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'exportDeliveriesData'),
        ),
      );
    }
    return handle;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public exportProcessingPerformanceData(
    ApiProcessingPerformanceRequest: ApiProcessingPerformanceRequest,
    language?: 'EN' | 'DE' | 'RW' | 'ES',
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public exportProcessingPerformanceData(
    ...
    if (
      ...
      throw new Error(
        'Required parameter ApiProcessingPerformanceRequest was null or undefined when calling exportProcessingPerformanceData.',
      );
    }
    ...
    const handle = this.httpClient.post(
      `${this.configuration.basePath}/api/dashboard/processing-performance-data/export`,
      ApiProcessingPerformanceRequest,
      {
        responseType: 'blob',
        withCredentials: this.configuration.withCredentials,
  ...
  public getDeliveriesAggregatedDataByMap(
    ...
    observe?: 'body',
    reportProgress?: boolean,
  ): Observable<ApiResponseApiDeliveriesTotal>;
  public getDeliveriesAggregatedDataByMap(
    map: GetDeliveriesAggregatedData.PartialParamMap,
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiResponseApiDeliveriesTotal>>;
  public getDeliveriesAggregatedDataByMap(
    map: GetDeliveriesAggregatedData.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiResponseApiDeliveriesTotal>>;
  public getDeliveriesAggregatedDataByMap(
    map: GetDeliveriesAggregatedData.PartialParamMap,
    observe: any = 'body',
    reportProgress: boolean = false,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getDeliveriesAggregatedData(
    companyId: number,
    aggregationType: 'DAY' | 'WEEK' | 'MONTH' | 'YEAR',
    facilityIds?: Array<number>,
    semiProductId?: number,
  ...
  public getDeliveriesAggregatedData(
    ...
    if (companyId === null || companyId === undefined) {
      throw new Error(
        'Required parameter companyId was null or undefined when calling getDeliveriesAggregatedData.',
      );
    }
    if (aggregationType === null || aggregationType === undefined) {
      throw new Error(
        'Required parameter aggregationType was null or undefined when calling getDeliveriesAggregatedData.',
      );
    }
    ...
    const handle = this.httpClient.get<ApiResponseApiDeliveriesTotal>(
      `${this.configuration.basePath}/api/dashboard/deliveries-aggregated-data`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getDeliveriesAggregatedData'),
        ),
      );
    }
    return handle;
