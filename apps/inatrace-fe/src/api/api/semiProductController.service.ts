...
export namespace CreateOrUpdateSemiProduct {
  ...
  export const ParamValidators: {
    [K in keyof CreateOrUpdateSemiProduct.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {};
...
export namespace DeleteSemiProduct {
   ...
   */
  export const ParamValidators: {
    [K in keyof DeleteSemiProduct.PartialParamMap]?: [string, ValidatorFn][];
  } = {
...
export namespace GetSemiProduct {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetSemiProduct.PartialParamMap]?: [string, ValidatorFn][];
  } = {
    id: [['required', Validators.required]],
    language: [],
  };
...
export namespace GetSemiProductDetails {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetSemiProductDetails.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export namespace GetSemiProductList {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetSemiProductList.PartialParamMap]?: [string, ValidatorFn][];
  } = {
    requestType: [],
...
export namespace GetSemiProductListByValueChains {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetSemiProductListByValueChains.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export class SemiProductControllerService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public createOrUpdateSemiProduct(
    ApiSemiProduct: ApiSemiProduct,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public createOrUpdateSemiProduct(
    ...
    if (ApiSemiProduct === null || ApiSemiProduct === undefined) {
      throw new Error(
        'Required parameter ApiSemiProduct was null or undefined when calling createOrUpdateSemiProduct.',
      );
    }
    ...
    const handle = this.httpClient.put<ApiResponseApiBaseEntity>(
      `${this.configuration.basePath}/api/chain/semi-product`,
      ApiSemiProduct,
      {
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'createOrUpdateSemiProduct'),
        ),
      );
    }
    return handle;
  ...
  public deleteSemiProductByMap(
    ...
    return this.deleteSemiProduct(map.id, observe, reportProgress);
  }
  ...
  public deleteSemiProduct(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling deleteSemiProduct.',
      );
    }
    ...
    const handle = this.httpClient.delete<ApiDefaultResponse>(
      `${this.configuration.basePath}/api/chain/semi-product/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'deleteSemiProduct'),
        ),
      );
    }
    return handle;
  ...
  public getSemiProductByMap(
    ...
    observe?: 'body',
    reportProgress?: boolean,
  ): Observable<ApiResponseApiSemiProduct>;
  public getSemiProductByMap(
    map: GetSemiProduct.PartialParamMap,
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiResponseApiSemiProduct>>;
  public getSemiProductByMap(
    map: GetSemiProduct.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiResponseApiSemiProduct>>;
  public getSemiProductByMap(
    map: GetSemiProduct.PartialParamMap,
    observe: any = 'body',
    reportProgress: boolean = false,
  ): Observable<any> {
    return this.getSemiProduct(map.id, map.language, observe, reportProgress);
  }
  ...
  public getSemiProduct(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSemiProduct.',
      );
    }
    ...
    const handle = this.httpClient.get<ApiResponseApiSemiProduct>(
      `${this.configuration.basePath}/api/chain/semi-product/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getSemiProduct'),
        ),
      );
    }
    return handle;
  ...
  public getSemiProductDetails(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSemiProductDetails.',
      );
    }
    ...
    const handle = this.httpClient.get<ApiResponseApiSemiProduct>(
      `${this.configuration.basePath}/api/chain/semi-product/${encodeURIComponent(String(id))}/detail`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getSemiProductDetails'),
        ),
      );
    }
    return handle;
  ...
  public getSemiProductListByMap(
    ...
    observe?: 'body',
    reportProgress?: boolean,
  ): Observable<ApiPaginatedResponseApiSemiProduct>;
  public getSemiProductListByMap(
    map: GetSemiProductList.PartialParamMap,
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiPaginatedResponseApiSemiProduct>>;
  public getSemiProductListByMap(
    map: GetSemiProductList.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiPaginatedResponseApiSemiProduct>>;
  public getSemiProductListByMap(
    map: GetSemiProductList.PartialParamMap,
    observe: any = 'body',
    reportProgress: boolean = false,
  ...
  public getSemiProductList(
    ...
    const handle = this.httpClient.get<ApiPaginatedResponseApiSemiProduct>(
      `${this.configuration.basePath}/api/chain/semi-product/list`,
      {
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getSemiProductList'),
        ),
      );
    }
    return handle;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSemiProductListByValueChains(
    valueChainIds: Array<number>,
    requestType?: 'COUNT' | 'FETCH',
    limit?: number,
    offset?: number,
  ...
  public getSemiProductListByValueChains(
    ...
    if (valueChainIds === null || valueChainIds === undefined) {
      throw new Error(
        'Required parameter valueChainIds was null or undefined when calling getSemiProductListByValueChains.',
      );
    }
    ...
    const handle = this.httpClient.get<ApiPaginatedResponseApiSemiProduct>(
      `${this.configuration.basePath}/api/chain/semi-product/list/by-value-chains`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
