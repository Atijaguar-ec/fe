...
export namespace GeneratePaymentsByCompanyCsv {
  ...
  export const ParamValidators: {
    [K in keyof GeneratePaymentsByCompanyCsv.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export namespace GeneratePurchasesByCompanyCsv {
   ...
   */
  export const ParamValidators: {
    [K in keyof GeneratePurchasesByCompanyCsv.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export class CommonCsvControllerService {
  ...
  public generatePaymentsByCompanyCsv(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling generatePaymentsByCompanyCsv.',
      );
    }
    ...
    const handle = this.httpClient.post<string>(
      `${this.configuration.basePath}/api/chain/csv/payments/company/${encodeURIComponent(String(id))}`,
      null,
      {
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'generatePaymentsByCompanyCsv'),
        ),
      );
    }
    return handle;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public generatePurchasesByCompanyCsv(
    id: number,
    language?: 'EN' | 'DE' | 'RW' | 'ES',
    requestType?: 'COUNT' | 'FETCH',
    limit?: number,
  ...
  public generatePurchasesByCompanyCsv(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling generatePurchasesByCompanyCsv.',
      );
    }
    ...
    const handle = this.httpClient.post<string>(
      `${this.configuration.basePath}/api/chain/csv/purchases/company/${encodeURIComponent(String(id))}`,
      null,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'generatePurchasesByCompanyCsv'),
        ),
      );
    }
    return handle;
