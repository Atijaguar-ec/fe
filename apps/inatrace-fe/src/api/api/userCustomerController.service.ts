...
export namespace GetUserCustomerListForCompanyUsingGET {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetUserCustomerListForCompanyUsingGET.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export namespace GetUserCustomerListUsingGET {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetUserCustomerListUsingGET.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export class UserCustomerControllerService {
  ...
  public getUserCustomerByMap(
    ...
    return this.getUserCustomer(map.id, observe, reportProgress);
  }
  ...
  public getUserCustomer(
    ...
    const handle = this.httpClient.get<ApiResponseApiUserCustomer>(
      `${this.configuration.basePath}/api/chain/user-customer/${encodeURIComponent(String(id))}`,
      {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getUserCustomerListForCompanyUsingGET(
    companyId: number,
    requestType?: 'COUNT' | 'FETCH',
    limit?: number,
    offset?: number,
  ...
  public getUserCustomerListForCompanyUsingGET(
    ...
    if (companyId === null || companyId === undefined) {
      throw new Error(
        'Required parameter companyId was null or undefined when calling getUserCustomerListForCompanyUsingGET.',
      );
    }
    ...
    const handle = this.httpClient.get<ApiPaginatedResponseApiUserCustomer>(
      `${this.configuration.basePath}/api/chain/user-customer/list/company/${encodeURIComponent(String(companyId))}`,
      {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getUserCustomerListUsingGET(
    requestType?: 'COUNT' | 'FETCH',
    limit?: number,
    offset?: number,
    sortBy?: string,
  ...
  public getUserCustomerListUsingGET(
    ...
    const handle = this.httpClient.get<ApiPaginatedResponseApiUserCustomer>(
      `${this.configuration.basePath}/api/chain/user-customer/list`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getUserCustomerListUsingGET'),
        ),
      );
    }
    return handle;
