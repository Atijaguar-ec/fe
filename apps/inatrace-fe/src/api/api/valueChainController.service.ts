...
export namespace CreateOrUpdateValueChain {
  ...
  export const ParamValidators: {
    [K in keyof CreateOrUpdateValueChain.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {};
...
export namespace DeleteValueChain {
   ...
   */
  export const ParamValidators: {
    [K in keyof DeleteValueChain.PartialParamMap]?: [string, ValidatorFn][];
  } = {
...
export namespace DisableValueChain {
   ...
   */
  export const ParamValidators: {
    [K in keyof DisableValueChain.PartialParamMap]?: [string, ValidatorFn][];
  } = {
    id: [['required', Validators.required]],
  };
}
...
export namespace EnableValueChain {
   ...
   */
  export const ParamValidators: {
    [K in keyof EnableValueChain.PartialParamMap]?: [string, ValidatorFn][];
  } = {
    id: [['required', Validators.required]],
  };
}
...
export namespace GetValueChain {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetValueChain.PartialParamMap]?: [string, ValidatorFn][];
  } = {
    id: [['required', Validators.required]],
    language: [],
  };
...
export namespace GetValueChainList {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetValueChainList.PartialParamMap]?: [string, ValidatorFn][];
  } = {
    name: [],
    valueChainStatus: [],
    productTypeId: [],
...
export class ValueChainControllerService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public createOrUpdateValueChain(
    ApiValueChain: ApiValueChain,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public createOrUpdateValueChain(
    ...
    if (ApiValueChain === null || ApiValueChain === undefined) {
      throw new Error(
        'Required parameter ApiValueChain was null or undefined when calling createOrUpdateValueChain.',
      );
    }
    ...
    const handle = this.httpClient.put<ApiResponseApiBaseEntity>(
      `${this.configuration.basePath}/api/chain/value-chain`,
      ApiValueChain,
      {
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'createOrUpdateValueChain'),
        ),
      );
    }
    return handle;
  ...
  public deleteValueChainByMap(
    ...
    return this.deleteValueChain(map.id, observe, reportProgress);
  }
  ...
  public deleteValueChain(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling deleteValueChain.',
      );
    }
    ...
    const handle = this.httpClient.delete<ApiDefaultResponse>(
      `${this.configuration.basePath}/api/chain/value-chain/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'deleteValueChain'),
        ),
      );
    }
    return handle;
  ...
  public disableValueChainByMap(
    ...
    return this.disableValueChain(map.id, observe, reportProgress);
  }
  ...
  public disableValueChain(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling disableValueChain.',
      );
    }
    ...
    const handle = this.httpClient.post<ApiResponseApiBaseEntity>(
      `${this.configuration.basePath}/api/chain/value-chain/${encodeURIComponent(String(id))}/disable`,
      null,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'disableValueChain'),
        ),
      );
    }
    return handle;
  ...
  public enableValueChainByMap(
    ...
    return this.enableValueChain(map.id, observe, reportProgress);
  }
  ...
  public enableValueChain(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling enableValueChain.',
      );
    }
    ...
    const handle = this.httpClient.post<ApiResponseApiBaseEntity>(
      `${this.configuration.basePath}/api/chain/value-chain/${encodeURIComponent(String(id))}/enable`,
      null,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'enableValueChain'),
        ),
      );
    }
    return handle;
  ...
  public getValueChainByMap(
    ...
    observe?: 'body',
    reportProgress?: boolean,
  ): Observable<ApiResponseApiValueChain>;
  public getValueChainByMap(
    map: GetValueChain.PartialParamMap,
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiResponseApiValueChain>>;
  public getValueChainByMap(
    map: GetValueChain.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiResponseApiValueChain>>;
  public getValueChainByMap(
    map: GetValueChain.PartialParamMap,
    observe: any = 'body',
    reportProgress: boolean = false,
  ): Observable<any> {
    return this.getValueChain(map.id, map.language, observe, reportProgress);
  }
  ...
  public getValueChain(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getValueChain.',
      );
    }
    ...
    const handle = this.httpClient.get<ApiResponseApiValueChain>(
      `${this.configuration.basePath}/api/chain/value-chain/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getValueChain'),
        ),
      );
    }
    return handle;
  ...
  public getValueChainList(
    ...
    const handle = this.httpClient.get<ApiPaginatedResponseApiValueChain>(
      `${this.configuration.basePath}/api/chain/value-chain/list`,
      {
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getValueChainList'),
        ),
      );
    }
    return handle;
