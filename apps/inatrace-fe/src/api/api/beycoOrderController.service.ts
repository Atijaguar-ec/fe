...
export namespace GetBeycoOrderFieldsForSelectedStockOrders {
  ...
  export const ParamValidators: {
    [K in keyof GetBeycoOrderFieldsForSelectedStockOrders.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export namespace GetToken {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetToken.PartialParamMap]?: [string, ValidatorFn][];
  } = {
...
export namespace RefreshToken {
   ...
   */
  export const ParamValidators: {
    [K in keyof RefreshToken.PartialParamMap]?: [string, ValidatorFn][];
  } = {
...
export namespace SendBeycoOrder {
   ...
   */
  export const ParamValidators: {
    [K in keyof SendBeycoOrder.PartialParamMap]?: [string, ValidatorFn][];
  } = {
...
export class BeycoOrderControllerService {
  ...
  ): Observable<ApiResponseApiBeycoOrderFields>;
  public getBeycoOrderFieldsForSelectedStockOrdersByMap(
    map: GetBeycoOrderFieldsForSelectedStockOrders.PartialParamMap,
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiResponseApiBeycoOrderFields>>;
  public getBeycoOrderFieldsForSelectedStockOrdersByMap(
    map: GetBeycoOrderFieldsForSelectedStockOrders.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiResponseApiBeycoOrderFields>>;
  public getBeycoOrderFieldsForSelectedStockOrdersByMap(
    map: GetBeycoOrderFieldsForSelectedStockOrders.PartialParamMap,
    observe: any = 'body',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getBeycoOrderFieldsForSelectedStockOrders(
    id: Array<number>,
    companyId: number,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public getBeycoOrderFieldsForSelectedStockOrders(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getBeycoOrderFieldsForSelectedStockOrders.',
      );
    }
    if (companyId === null || companyId === undefined) {
      throw new Error(
        'Required parameter companyId was null or undefined when calling getBeycoOrderFieldsForSelectedStockOrders.',
      );
    }
    ...
    const handle = this.httpClient.get<ApiResponseApiBeycoOrderFields>(
      `${this.configuration.basePath}/api/chain/beyco-order/company/${encodeURIComponent(String(companyId))}/fields`,
      {
  ...
  public getTokenByMap(
    ...
    observe?: 'body',
    reportProgress?: boolean,
  ): Observable<ApiResponseApiBeycoTokenResponse>;
  public getTokenByMap(
    map: GetToken.PartialParamMap,
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiResponseApiBeycoTokenResponse>>;
  public getTokenByMap(
    map: GetToken.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiResponseApiBeycoTokenResponse>>;
  public getTokenByMap(
    map: GetToken.PartialParamMap,
    observe: any = 'body',
    reportProgress: boolean = false,
  ): Observable<any> {
    return this.getToken(map.authCode, map.companyId, observe, reportProgress);
  }
  ...
  public getToken(
    ...
    if (authCode === null || authCode === undefined) {
      throw new Error(
        'Required parameter authCode was null or undefined when calling getToken.',
      );
    }
    if (companyId === null || companyId === undefined) {
      throw new Error(
        'Required parameter companyId was null or undefined when calling getToken.',
      );
    }
    ...
    const handle = this.httpClient.get<ApiResponseApiBeycoTokenResponse>(
      `${this.configuration.basePath}/api/chain/beyco-order/company/${encodeURIComponent(String(companyId))}/token`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) => this.configuration.errorHandler(err, 'getToken')),
      );
    }
    return handle;
  }
  ...
  public refreshToken(
    ...
    if (X_Beyco_Refresh_Token === null || X_Beyco_Refresh_Token === undefined) {
      throw new Error(
        'Required parameter X_Beyco_Refresh_Token was null or undefined when calling refreshToken.',
      );
    }
    if (companyId === null || companyId === undefined) {
      throw new Error(
        'Required parameter companyId was null or undefined when calling refreshToken.',
      );
    }
    ...
    if (X_Beyco_Refresh_Token !== undefined && X_Beyco_Refresh_Token !== null) {
      headers = headers.set(
        'X-Beyco-Refresh-Token',
        String(X_Beyco_Refresh_Token),
      );
    }
    ...
    const handle = this.httpClient.get<ApiResponseApiBeycoTokenResponse>(
      `${this.configuration.basePath}/api/chain/beyco-order/company/${encodeURIComponent(String(companyId))}/token/refresh`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'refreshToken'),
        ),
      );
    }
    return handle;
  ...
  public sendBeycoOrderByMap(
    ...
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiResponseObject>>;
  public sendBeycoOrderByMap(
    map: SendBeycoOrder.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiResponseObject>>;
  public sendBeycoOrderByMap(
    map: SendBeycoOrder.PartialParamMap,
    observe: any = 'body',
    reportProgress: boolean = false,
  ...
  public sendBeycoOrder(
    ...
    if (X_Beyco_Token === null || X_Beyco_Token === undefined) {
      throw new Error(
        'Required parameter X_Beyco_Token was null or undefined when calling sendBeycoOrder.',
      );
    }
    if (companyId === null || companyId === undefined) {
      throw new Error(
        'Required parameter companyId was null or undefined when calling sendBeycoOrder.',
      );
    }
    if (ApiBeycoOrderFields === null || ApiBeycoOrderFields === undefined) {
      throw new Error(
        'Required parameter ApiBeycoOrderFields was null or undefined when calling sendBeycoOrder.',
      );
    }
    ...
    const handle = this.httpClient.post<ApiResponseObject>(
      `${this.configuration.basePath}/api/chain/beyco-order/company/${encodeURIComponent(String(companyId))}/order`,
      ApiBeycoOrderFields,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'sendBeycoOrder'),
        ),
      );
    }
    return handle;
