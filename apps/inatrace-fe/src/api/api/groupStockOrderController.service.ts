...
export namespace GetGroupedStockOrderList {
  ...
  export const ParamValidators: {
    [K in keyof GetGroupedStockOrderList.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export class GroupStockOrderControllerService {
  ...
  public getGroupedStockOrderListByMap(
    ...
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiPaginatedResponseApiGroupStockOrder>>;
  public getGroupedStockOrderListByMap(
    map: GetGroupedStockOrderList.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiPaginatedResponseApiGroupStockOrder>>;
  public getGroupedStockOrderListByMap(
    map: GetGroupedStockOrderList.PartialParamMap,
    observe: any = 'body',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getGroupedStockOrderList(
    facilityId: number,
    requestType?: 'COUNT' | 'FETCH',
    limit?: number,
    offset?: number,
  ...
  public getGroupedStockOrderList(
    ...
    if (facilityId === null || facilityId === undefined) {
      throw new Error(
        'Required parameter facilityId was null or undefined when calling getGroupedStockOrderList.',
      );
    }
    ...
    const handle = this.httpClient.get<ApiPaginatedResponseApiGroupStockOrder>(
      `${this.configuration.basePath}/api/chain/group-stock-order/list/facility/${encodeURIComponent(String(facilityId))}`,
      {
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getGroupedStockOrderList'),
        ),
      );
    }
    return handle;
