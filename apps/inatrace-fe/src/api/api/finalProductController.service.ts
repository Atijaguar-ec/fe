...
export namespace GetFinalProductsForCompany {
  ...
  export const ParamValidators: {
    [K in keyof GetFinalProductsForCompany.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export class FinalProductControllerService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getFinalProductsForCompany(
    companyId: number,
    requestType?: 'COUNT' | 'FETCH',
    limit?: number,
    offset?: number,
  ...
  public getFinalProductsForCompany(
    ...
    if (companyId === null || companyId === undefined) {
      throw new Error(
        'Required parameter companyId was null or undefined when calling getFinalProductsForCompany.',
      );
    }
    ...
    const handle = this.httpClient.get<ApiPaginatedResponseApiFinalProduct>(
      `${this.configuration.basePath}/api/final-product/company/${encodeURIComponent(String(companyId))}`,
      {
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getFinalProductsForCompany'),
        ),
      );
    }
    return handle;
