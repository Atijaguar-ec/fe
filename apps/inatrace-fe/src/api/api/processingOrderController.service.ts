...
export namespace CreateOrUpdateProcessingOrder {
  ...
  export const ParamValidators: {
    [K in keyof CreateOrUpdateProcessingOrder.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export namespace DeleteProcessingOrder {
   ...
   */
  export const ParamValidators: {
    [K in keyof DeleteProcessingOrder.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export namespace GetProcessingOrder {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetProcessingOrder.PartialParamMap]?: [string, ValidatorFn][];
  } = {
    id: [['required', Validators.required]],
    language: [],
  };
...
export class ProcessingOrderControllerService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public createOrUpdateProcessingOrder(
    ApiProcessingOrder: ApiProcessingOrder,
    language?: 'EN' | 'DE' | 'RW' | 'ES',
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public createOrUpdateProcessingOrder(
    ...
    if (ApiProcessingOrder === null || ApiProcessingOrder === undefined) {
      throw new Error(
        'Required parameter ApiProcessingOrder was null or undefined when calling createOrUpdateProcessingOrder.',
      );
    }
    ...
    const handle = this.httpClient.put<ApiResponseApiBaseEntity>(
      `${this.configuration.basePath}/api/chain/processing-order`,
      ApiProcessingOrder,
      {
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'createOrUpdateProcessingOrder'),
        ),
      );
    }
    return handle;
  ...
  public deleteProcessingOrderByMap(
    ...
    return this.deleteProcessingOrder(map.id, observe, reportProgress);
  }
  ...
  public deleteProcessingOrder(
    ...
    const handle = this.httpClient.delete<ApiDefaultResponse>(
      `${this.configuration.basePath}/api/chain/processing-order/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'deleteProcessingOrder'),
        ),
      );
    }
    return handle;
  ...
  public getProcessingOrder(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getProcessingOrder.',
      );
    }
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getProcessingOrder'),
        ),
      );
    }
    return handle;
