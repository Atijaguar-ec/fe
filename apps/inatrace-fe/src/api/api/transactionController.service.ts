...
export namespace ApproveTransaction {
  ...
  export const ParamValidators: {
    [K in keyof ApproveTransaction.PartialParamMap]?: [string, ValidatorFn][];
  } = {
...
export namespace GetStockOrderInputTransactions {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetStockOrderInputTransactions.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
    stockOrderId: [['required', Validators.required]],
    language: [],
  };
}
...
export namespace RejectTransaction {
   ...
   */
  export const ParamValidators: {
    [K in keyof RejectTransaction.PartialParamMap]?: [string, ValidatorFn][];
  } = {
    id: [['required', Validators.required]],
    language: [],
  };
...
export class TransactionControllerService {
  ...
  public approveTransaction(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling approveTransaction.',
      );
    }
    ...
    const handle = this.httpClient.put<ApiDefaultResponse>(
      `${this.configuration.basePath}/api/chain/transaction/${encodeURIComponent(String(id))}/approve`,
      null,
      {
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'approveTransaction'),
        ),
      );
    }
    return handle;
  ...
  public getStockOrderInputTransactionsByMap(
    ...
    observe?: 'body',
    reportProgress?: boolean,
  ): Observable<ApiPaginatedResponseApiTransaction>;
  public getStockOrderInputTransactionsByMap(
    map: GetStockOrderInputTransactions.PartialParamMap,
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiPaginatedResponseApiTransaction>>;
  public getStockOrderInputTransactionsByMap(
    map: GetStockOrderInputTransactions.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiPaginatedResponseApiTransaction>>;
  public getStockOrderInputTransactionsByMap(
    map: GetStockOrderInputTransactions.PartialParamMap,
    observe: any = 'body',
    reportProgress: boolean = false,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getStockOrderInputTransactions(
    stockOrderId: number,
    language?: 'EN' | 'DE' | 'RW' | 'ES',
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public getStockOrderInputTransactions(
    ...
    if (stockOrderId === null || stockOrderId === undefined) {
      throw new Error(
        'Required parameter stockOrderId was null or undefined when calling getStockOrderInputTransactions.',
      );
    }
    ...
    const handle = this.httpClient.get<ApiPaginatedResponseApiTransaction>(
      `${this.configuration.basePath}/api/chain/transaction/list/input/stock-order/${encodeURIComponent(String(stockOrderId))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
      ...
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(
            err,
            'getStockOrderInputTransactions',
          ),
        ),
      );
    }
  ...
  public rejectTransaction(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling rejectTransaction.',
      );
    }
    if (ApiTransaction === null || ApiTransaction === undefined) {
      throw new Error(
        'Required parameter ApiTransaction was null or undefined when calling rejectTransaction.',
      );
    }
    ...
    const handle = this.httpClient.put<ApiDefaultResponse>(
      `${this.configuration.basePath}/api/chain/transaction/${encodeURIComponent(String(id))}/reject`,
      ApiTransaction,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'rejectTransaction'),
        ),
      );
    }
    return handle;
