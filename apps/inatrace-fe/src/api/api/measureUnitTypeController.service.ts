...
export namespace CreateOrUpdateMeasurementUnitType {
  ...
  export const ParamValidators: {
    [K in keyof CreateOrUpdateMeasurementUnitType.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {};
...
export namespace DeleteMeasurementUnitType {
   ...
   */
  export const ParamValidators: {
    [K in keyof DeleteMeasurementUnitType.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export namespace GetMeasureUnitTypeList {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetMeasureUnitTypeList.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export namespace GetMeasurementUnitType {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetMeasurementUnitType.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export class MeasureUnitTypeControllerService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public createOrUpdateMeasurementUnitType(
    ApiMeasureUnitType: ApiMeasureUnitType,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public createOrUpdateMeasurementUnitType(
    ...
    if (ApiMeasureUnitType === null || ApiMeasureUnitType === undefined) {
      throw new Error(
        'Required parameter ApiMeasureUnitType was null or undefined when calling createOrUpdateMeasurementUnitType.',
      );
    }
    ...
    const handle = this.httpClient.put<ApiResponseApiBaseEntity>(
      `${this.configuration.basePath}/api/chain/measure-unit-type`,
      ApiMeasureUnitType,
      {
      ...
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(
            err,
            'createOrUpdateMeasurementUnitType',
          ),
        ),
      );
    }
  ...
  public deleteMeasurementUnitTypeByMap(
    ...
    return this.deleteMeasurementUnitType(map.id, observe, reportProgress);
  }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public deleteMeasurementUnitType(
    id: number,
    observe?: 'body',
    reportProgress?: boolean,
    additionalHeaders?: Array<Array<string>>,
  ...
  public deleteMeasurementUnitType(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling deleteMeasurementUnitType.',
      );
    }
    ...
    const handle = this.httpClient.delete<ApiDefaultResponse>(
      `${this.configuration.basePath}/api/chain/measure-unit-type/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'deleteMeasurementUnitType'),
        ),
      );
    }
    return handle;
  ...
  public getMeasureUnitTypeListByMap(
    ...
    observe?: 'body',
    reportProgress?: boolean,
  ): Observable<ApiPaginatedResponseApiMeasureUnitType>;
  public getMeasureUnitTypeListByMap(
    map: GetMeasureUnitTypeList.PartialParamMap,
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiPaginatedResponseApiMeasureUnitType>>;
  public getMeasureUnitTypeListByMap(
    map: GetMeasureUnitTypeList.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiPaginatedResponseApiMeasureUnitType>>;
  public getMeasureUnitTypeListByMap(
    map: GetMeasureUnitTypeList.PartialParamMap,
    observe: any = 'body',
    reportProgress: boolean = false,
  ...
  public getMeasureUnitTypeList(
    ...
    const handle = this.httpClient.get<ApiPaginatedResponseApiMeasureUnitType>(
      `${this.configuration.basePath}/api/chain/measure-unit-type/list`,
      {
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getMeasureUnitTypeList'),
        ),
      );
    }
    return handle;
  ...
  public getMeasurementUnitTypeByMap(
    ...
    observe?: 'body',
    reportProgress?: boolean,
  ): Observable<ApiResponseApiMeasureUnitType>;
  public getMeasurementUnitTypeByMap(
    map: GetMeasurementUnitType.PartialParamMap,
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiResponseApiMeasureUnitType>>;
  public getMeasurementUnitTypeByMap(
    map: GetMeasurementUnitType.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiResponseApiMeasureUnitType>>;
  public getMeasurementUnitTypeByMap(
    map: GetMeasurementUnitType.PartialParamMap,
    observe: any = 'body',
    reportProgress: boolean = false,
  ): Observable<any> {
    return this.getMeasurementUnitType(map.id, observe, reportProgress);
  }
  ...
  public getMeasurementUnitType(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getMeasurementUnitType.',
      );
    }
    ...
    const handle = this.httpClient.get<ApiResponseApiMeasureUnitType>(
      `${this.configuration.basePath}/api/chain/measure-unit-type/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getMeasurementUnitType'),
        ),
      );
    }
    return handle;
