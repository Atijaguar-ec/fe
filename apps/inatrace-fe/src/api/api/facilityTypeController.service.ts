...
export namespace CreateOrUpdateFacilityType {
  ...
  export const ParamValidators: {
    [K in keyof CreateOrUpdateFacilityType.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {};
...
export namespace DeleteFacilityType {
   ...
   */
  export const ParamValidators: {
    [K in keyof DeleteFacilityType.PartialParamMap]?: [string, ValidatorFn][];
  } = {
...
export namespace GetFacilityType {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetFacilityType.PartialParamMap]?: [string, ValidatorFn][];
  } = {
    id: [['required', Validators.required]],
  };
}
...
export namespace GetFacilityTypeList {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetFacilityTypeList.PartialParamMap]?: [string, ValidatorFn][];
  } = {
    requestType: [],
...
export class FacilityTypeControllerService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public createOrUpdateFacilityType(
    ApiFacilityType: ApiFacilityType,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public createOrUpdateFacilityType(
    ...
    if (ApiFacilityType === null || ApiFacilityType === undefined) {
      throw new Error(
        'Required parameter ApiFacilityType was null or undefined when calling createOrUpdateFacilityType.',
      );
    }
    ...
    const handle = this.httpClient.put<ApiResponseApiBaseEntity>(
      `${this.configuration.basePath}/api/chain/facility-type`,
      ApiFacilityType,
      {
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'createOrUpdateFacilityType'),
        ),
      );
    }
    return handle;
  ...
  public deleteFacilityTypeByMap(
    ...
    return this.deleteFacilityType(map.id, observe, reportProgress);
  }
  ...
  public deleteFacilityType(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling deleteFacilityType.',
      );
    }
    ...
    const handle = this.httpClient.delete<ApiDefaultResponse>(
      `${this.configuration.basePath}/api/chain/facility-type/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'deleteFacilityType'),
        ),
      );
    }
    return handle;
  ...
  public getFacilityTypeByMap(
    ...
    observe?: 'body',
    reportProgress?: boolean,
  ): Observable<ApiResponseApiFacilityType>;
  public getFacilityTypeByMap(
    map: GetFacilityType.PartialParamMap,
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiResponseApiFacilityType>>;
  public getFacilityTypeByMap(
    map: GetFacilityType.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiResponseApiFacilityType>>;
  public getFacilityTypeByMap(
    map: GetFacilityType.PartialParamMap,
    observe: any = 'body',
    reportProgress: boolean = false,
  ): Observable<any> {
    return this.getFacilityType(map.id, observe, reportProgress);
  }
  ...
  public getFacilityType(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getFacilityType.',
      );
    }
    ...
    const handle = this.httpClient.get<ApiResponseApiFacilityType>(
      `${this.configuration.basePath}/api/chain/facility-type/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getFacilityType'),
        ),
      );
    }
    return handle;
  ...
  public getFacilityTypeListByMap(
    ...
    observe?: 'body',
    reportProgress?: boolean,
  ): Observable<ApiPaginatedResponseApiFacilityType>;
  public getFacilityTypeListByMap(
    map: GetFacilityTypeList.PartialParamMap,
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiPaginatedResponseApiFacilityType>>;
  public getFacilityTypeListByMap(
    map: GetFacilityTypeList.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiPaginatedResponseApiFacilityType>>;
  public getFacilityTypeListByMap(
    map: GetFacilityTypeList.PartialParamMap,
    observe: any = 'body',
    reportProgress: boolean = false,
  ...
  public getFacilityTypeList(
    ...
    const handle = this.httpClient.get<ApiPaginatedResponseApiFacilityType>(
      `${this.configuration.basePath}/api/chain/facility-type/list`,
      {
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getFacilityTypeList'),
        ),
      );
    }
    return handle;
