...
export namespace ErrorHtmlUsingDELETE {
  ...
  export const ParamValidators: {
    [K in keyof ErrorHtmlUsingDELETE.PartialParamMap]?: [string, ValidatorFn][];
  } = {};
}
...
export namespace ErrorHtmlUsingGET {
   ...
   */
  export const ParamValidators: {
    [K in keyof ErrorHtmlUsingGET.PartialParamMap]?: [string, ValidatorFn][];
  } = {};
}
...
export namespace ErrorHtmlUsingHEAD {
   ...
   */
  export const ParamValidators: {
    [K in keyof ErrorHtmlUsingHEAD.PartialParamMap]?: [string, ValidatorFn][];
  } = {};
}
...
export namespace ErrorHtmlUsingOPTIONS {
   ...
   */
  export const ParamValidators: {
    [K in keyof ErrorHtmlUsingOPTIONS.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {};
...
export namespace ErrorHtmlUsingPATCH {
   ...
   */
  export const ParamValidators: {
    [K in keyof ErrorHtmlUsingPATCH.PartialParamMap]?: [string, ValidatorFn][];
  } = {};
}
...
export namespace ErrorHtmlUsingPOST {
   ...
   */
  export const ParamValidators: {
    [K in keyof ErrorHtmlUsingPOST.PartialParamMap]?: [string, ValidatorFn][];
  } = {};
}
...
export namespace ErrorHtmlUsingPUT {
   ...
   */
  export const ParamValidators: {
    [K in keyof ErrorHtmlUsingPUT.PartialParamMap]?: [string, ValidatorFn][];
  } = {};
}
...
export class BasicErrorControllerService {
  ...
  public errorHtmlUsingDELETEByMap(
    ...
    return this.errorHtmlUsingDELETE(observe, reportProgress);
  }
  ...
  public errorHtmlUsingDELETE(
    ...
    const handle = this.httpClient.delete<ModelAndView>(
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'errorHtmlUsingDELETE'),
        ),
      );
    }
    return handle;
  ...
  public errorHtmlUsingGETByMap(
    ...
    return this.errorHtmlUsingGET(observe, reportProgress);
  }
  ...
  public errorHtmlUsingGET(
    ...
    const handle = this.httpClient.get<ModelAndView>(
      `${this.configuration.basePath}/error`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'errorHtmlUsingGET'),
        ),
      );
    }
    return handle;
  ...
  public errorHtmlUsingHEADByMap(
    ...
    return this.errorHtmlUsingHEAD(observe, reportProgress);
  }
  ...
  public errorHtmlUsingHEAD(
    ...
    const handle = this.httpClient.head<ModelAndView>(
      `${this.configuration.basePath}/error`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'errorHtmlUsingHEAD'),
        ),
      );
    }
    return handle;
  ...
  public errorHtmlUsingOPTIONSByMap(
    ...
    return this.errorHtmlUsingOPTIONS(observe, reportProgress);
  }
  ...
  public errorHtmlUsingOPTIONS(
    ...
    const handle = this.httpClient.options<ModelAndView>(
      `${this.configuration.basePath}/error`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'errorHtmlUsingOPTIONS'),
        ),
      );
    }
    return handle;
  ...
  public errorHtmlUsingPATCHByMap(
    ...
    return this.errorHtmlUsingPATCH(observe, reportProgress);
  }
  ...
  public errorHtmlUsingPATCH(
    ...
    const handle = this.httpClient.patch<ModelAndView>(
      `${this.configuration.basePath}/error`,
      null,
      {
        withCredentials: this.configuration.withCredentials,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'errorHtmlUsingPATCH'),
        ),
      );
    }
    return handle;
  ...
  public errorHtmlUsingPOSTByMap(
    ...
    return this.errorHtmlUsingPOST(observe, reportProgress);
  }
  ...
  public errorHtmlUsingPOST(
    ...
    const handle = this.httpClient.post<ModelAndView>(
      `${this.configuration.basePath}/error`,
      null,
      {
        withCredentials: this.configuration.withCredentials,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'errorHtmlUsingPOST'),
        ),
      );
    }
    return handle;
  ...
  public errorHtmlUsingPUTByMap(
    ...
    return this.errorHtmlUsingPUT(observe, reportProgress);
  }
  ...
  public errorHtmlUsingPUT(
    ...
    const handle = this.httpClient.put<ModelAndView>(
      `${this.configuration.basePath}/error`,
      null,
      {
        withCredentials: this.configuration.withCredentials,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'errorHtmlUsingPUT'),
        ),
      );
    }
    return handle;
