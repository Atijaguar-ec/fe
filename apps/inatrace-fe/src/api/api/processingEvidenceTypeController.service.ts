...
export namespace CreateOrUpdateProcessingEvidenceType {
  ...
  export const ParamValidators: {
    [K in keyof CreateOrUpdateProcessingEvidenceType.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {};
...
export namespace DeleteProcessingEvidenceType {
   ...
   */
  export const ParamValidators: {
    [K in keyof DeleteProcessingEvidenceType.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export namespace GetProcessingEvidenceType {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetProcessingEvidenceType.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export namespace GetProcessingEvidenceTypeList {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetProcessingEvidenceTypeList.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export namespace ListProcessingEvidenceTypesByValueChain {
   ...
   */
  export const ParamValidators: {
    [K in keyof ListProcessingEvidenceTypesByValueChain.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
...
export namespace ListProcessingEvidenceTypesByValueChains {
   ...
   */
  export const ParamValidators: {
    [K in keyof ListProcessingEvidenceTypesByValueChains.PartialParamMap]?: [
      string,
      ValidatorFn,
    ][];
  } = {
    valueChainIds: [['required', Validators.required]],
    requestType: [],
    limit: [['min', Validators.min(1)]],
    offset: [['min', Validators.min(0)]],
    sortBy: [],
...
export class ProcessingEvidenceTypeControllerService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public createOrUpdateProcessingEvidenceType(
    ApiProcessingEvidenceType: ApiProcessingEvidenceType,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public createOrUpdateProcessingEvidenceType(
    ...
    if (
      ApiProcessingEvidenceType === null ||
      ApiProcessingEvidenceType === undefined
    ) {
      throw new Error(
        'Required parameter ApiProcessingEvidenceType was null or undefined when calling createOrUpdateProcessingEvidenceType.',
      );
    }
    ...
    const handle = this.httpClient.put<ApiResponseApiBaseEntity>(
      `${this.configuration.basePath}/api/chain/processing-evidence-type`,
      ...
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(
            err,
            'createOrUpdateProcessingEvidenceType',
          ),
        ),
      );
    }
  ...
  public deleteProcessingEvidenceTypeByMap(
    ...
    return this.deleteProcessingEvidenceType(map.id, observe, reportProgress);
  }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public deleteProcessingEvidenceType(
    id: number,
    observe?: 'body',
    reportProgress?: boolean,
    additionalHeaders?: Array<Array<string>>,
  ...
  public deleteProcessingEvidenceType(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling deleteProcessingEvidenceType.',
      );
    }
    ...
    const handle = this.httpClient.delete<ApiDefaultResponse>(
      `${this.configuration.basePath}/api/chain/processing-evidence-type/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'deleteProcessingEvidenceType'),
        ),
      );
    }
    return handle;
  ...
  public getProcessingEvidenceTypeByMap(
    ...
    observe?: 'body',
    reportProgress?: boolean,
  ): Observable<ApiResponseApiProcessingEvidenceType>;
  public getProcessingEvidenceTypeByMap(
    map: GetProcessingEvidenceType.PartialParamMap,
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiResponseApiProcessingEvidenceType>>;
  public getProcessingEvidenceTypeByMap(
    map: GetProcessingEvidenceType.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiResponseApiProcessingEvidenceType>>;
  public getProcessingEvidenceTypeByMap(
    map: GetProcessingEvidenceType.PartialParamMap,
    observe: any = 'body',
    reportProgress: boolean = false,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getProcessingEvidenceType(
    id: number,
    language?: 'EN' | 'DE' | 'RW' | 'ES',
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public getProcessingEvidenceType(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getProcessingEvidenceType.',
      );
    }
    ...
    const handle = this.httpClient.get<ApiResponseApiProcessingEvidenceType>(
      `${this.configuration.basePath}/api/chain/processing-evidence-type/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getProcessingEvidenceType'),
        ),
      );
    }
    return handle;
  ...
  public getProcessingEvidenceTypeListByMap(
    ...
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiPaginatedResponseApiProcessingEvidenceType>>;
  public getProcessingEvidenceTypeListByMap(
    map: GetProcessingEvidenceTypeList.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiPaginatedResponseApiProcessingEvidenceType>>;
  public getProcessingEvidenceTypeListByMap(
    map: GetProcessingEvidenceTypeList.PartialParamMap,
    observe: any = 'body',
    reportProgress: boolean = false,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getProcessingEvidenceTypeList(
    requestType?: 'COUNT' | 'FETCH',
    limit?: number,
    offset?: number,
    sortBy?: string,
  ...
  public getProcessingEvidenceTypeList(
    ...
    const handle =
      this.httpClient.get<ApiPaginatedResponseApiProcessingEvidenceType>(
        `${this.configuration.basePath}/api/chain/processing-evidence-type/list`,
        {
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getProcessingEvidenceTypeList'),
        ),
      );
    }
    return handle;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public listProcessingEvidenceTypesByValueChain(
    id: number,
    requestType?: 'COUNT' | 'FETCH',
    limit?: number,
    offset?: number,
  ...
  public listProcessingEvidenceTypesByValueChain(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling listProcessingEvidenceTypesByValueChain.',
      );
    }
    ...
    const handle =
      this.httpClient.get<ApiPaginatedResponseApiProcessingEvidenceType>(
        `${this.configuration.basePath}/api/chain/processing-evidence-type/list/value-chain/${encodeURIComponent(String(id))}`,
        {
          params: queryParameters,
          withCredentials: this.configuration.withCredentials,
          headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(
            err,
            'listProcessingEvidenceTypesByValueChain',
          ),
        ),
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public listProcessingEvidenceTypesByValueChains(
    valueChainIds: Array<number>,
    requestType?: 'COUNT' | 'FETCH',
    limit?: number,
    offset?: number,
  ...
  public listProcessingEvidenceTypesByValueChains(
    ...
    if (valueChainIds === null || valueChainIds === undefined) {
      throw new Error(
        'Required parameter valueChainIds was null or undefined when calling listProcessingEvidenceTypesByValueChains.',
      );
    }
    ...
    const handle =
      this.httpClient.get<ApiPaginatedResponseApiProcessingEvidenceType>(
        `${this.configuration.basePath}/api/chain/processing-evidence-type/list/by-value-chains`,
        {
          params: queryParameters,
          withCredentials: this.configuration.withCredentials,
          headers: headers,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(
            err,
            'listProcessingEvidenceTypesByValueChains',
          ),
        ),
      );
    }
