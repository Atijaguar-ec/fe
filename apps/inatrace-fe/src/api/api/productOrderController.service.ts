...
export namespace CreateProductOrder {
  ...
  export const ParamValidators: {
    [K in keyof CreateProductOrder.PartialParamMap]?: [string, ValidatorFn][];
  } = {
    language: [],
  };
}
...
export namespace GetProductOrder {
   ...
   */
  export const ParamValidators: {
    [K in keyof GetProductOrder.PartialParamMap]?: [string, ValidatorFn][];
  } = {
...
export class ProductOrderControllerService {
  ...
  public createProductOrder(
    ...
    if (ApiProductOrder === null || ApiProductOrder === undefined) {
      throw new Error(
        'Required parameter ApiProductOrder was null or undefined when calling createProductOrder.',
      );
    }
    ...
    const handle = this.httpClient.post<ApiResponseApiBaseEntity>(
      `${this.configuration.basePath}/api/chain/product-order`,
      ApiProductOrder,
      {
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'createProductOrder'),
        ),
      );
    }
    return handle;
  ...
  public getProductOrderByMap(
    ...
    observe?: 'body',
    reportProgress?: boolean,
  ): Observable<ApiResponseApiProductOrder>;
  public getProductOrderByMap(
    map: GetProductOrder.PartialParamMap,
    observe?: 'response',
    reportProgress?: boolean,
  ): Observable<HttpResponse<ApiResponseApiProductOrder>>;
  public getProductOrderByMap(
    map: GetProductOrder.PartialParamMap,
    observe?: 'events',
    reportProgress?: boolean,
  ): Observable<HttpEvent<ApiResponseApiProductOrder>>;
  public getProductOrderByMap(
    map: GetProductOrder.PartialParamMap,
    observe: any = 'body',
    reportProgress: boolean = false,
  ): Observable<any> {
    return this.getProductOrder(map.id, map.language, observe, reportProgress);
  }
  ...
  public getProductOrder(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getProductOrder.',
      );
    }
    ...
    const handle = this.httpClient.get<ApiResponseApiProductOrder>(
      `${this.configuration.basePath}/api/chain/product-order/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
    ...
    if (typeof this.configuration.errorHandler === 'function') {
      return handle.pipe(
        catchError((err) =>
          this.configuration.errorHandler(err, 'getProductOrder'),
        ),
      );
    }
    return handle;
