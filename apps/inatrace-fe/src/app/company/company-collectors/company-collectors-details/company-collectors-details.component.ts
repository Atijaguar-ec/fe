...
export class CompanyCollectorsDetailsComponent implements OnInit {
  ...
  representativeOfUserCustomerIdPing$ = new BehaviorSubject<number>(
  ...
  static ApiUserCustomerCooperativeEmptyObjectFormFactory(): () => UntypedFormControl {
    return () => {
      return new UntypedFormControl(
        CompanyCollectorsDetailsComponent.ApiUserCustomerCooperativeCreateEmptyObject(),
  ...
  static ApiCertificationEmptyObjectFormFactory(): () => UntypedFormControl {
    return () => {
      return new UntypedFormControl(
        CompanyCollectorsDetailsComponent.ApiCertificationCreateEmptyObject(),
  ...
  get certifications(): AbstractControl[] {
    return (this.collectorForm.get('certifications') as UntypedFormArray)
      .controls;
  }
  ...
  newCollector() {
    this.collectorForm = generateFormFromMetadata(
  ...
  emptyCollector() {
    const collector: ApiUserCustomer = defaultEmptyObject(
      ApiUserCustomer.formMetadata(),
    );

    collector.bank = defaultEmptyObject(
      ApiBankInformation.formMetadata(),
    ) as ApiBankInformation;
    collector.farm = defaultEmptyObject(
      ApiFarmInformation.formMetadata(),
    ) as ApiFarmInformation;
    collector.location = defaultEmptyObject(
      ApiLocation.formMetadata(),
    ) as ApiLocation;
    collector.location.address = defaultEmptyObject(
  ...
  prepareEdit() {
    if (this.collector.bank == null) {
      this.collector.bank = defaultEmptyObject(
        ApiBankInformation.formMetadata(),
      );
    }
  }
  ...
  initializeListManager() {
    this.producersListManager =
      new ListEditorManager<ApiUserCustomerCooperative>(
        this.collectorForm.get('cooperatives') as UntypedFormArray,
    ...
    this.certificationListManager = new ListEditorManager<ApiCertification>(
      this.collectorForm.get('certifications') as UntypedFormArray,
  ...
  addAssociation(item, form) {
    ...
    if (
      this.collectorForm.value.associations.some(
        (a) => a.company.id === item.id,
      )
    ) {
      form.setValue(null);
      return;
  ...
  public get areaUnit(): UntypedFormControl {
    return this.collectorForm.get('farm.areaUnit') as UntypedFormControl;
  }
