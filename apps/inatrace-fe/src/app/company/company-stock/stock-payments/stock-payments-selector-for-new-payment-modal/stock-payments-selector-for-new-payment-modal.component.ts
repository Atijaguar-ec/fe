...
export class StockPaymentsSelectorForNewPaymentModalComponent
  implements OnInit
{
  ...
  farmerForm = new UntypedFormControl(null);
  womenCoffeeOnlyForm = new UntypedFormControl(null);
  stockOrderForPaymentForm = new UntypedFormControl(null);
