...
export class StockPaymentsItemComponent
  extends GenericEditableItemComponent<ApiPayment>
  implements OnInit
{
  @Input()
  ...
  get name(): string {
    return this.contentObject
      ? this.contentObject.receiptNumber +
          ' (' +
          this.contentObject.amount +
          ' ' +
          this.contentObject.currency +
          ')'
      : '';
  }
}
