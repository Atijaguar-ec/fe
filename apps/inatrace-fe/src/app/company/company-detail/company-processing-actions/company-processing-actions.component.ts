...
import { CompanyDetailProcessingActionsAddWizardComponent } from './company-detail-processing-actions-add-wizard/company-detail-processing-actions-add-wizard.component';
...
export class CompanyProcessingActionsComponent
  ...
  implements OnInit, OnDestroy, AfterViewInit
{
  ...
  ngAfterViewInit() {
    ...
    this.subscriptions =
      this.selfOnboardingService.addProcessingActionCurrentStep$.subscribe(
        (step) => {
          if (step === 3) {
