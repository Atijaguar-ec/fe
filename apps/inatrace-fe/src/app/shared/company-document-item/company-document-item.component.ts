...
export class CompanyDocumentItemComponent
  extends GenericEditableItemComponent<ApiCompanyDocument>
  implements OnInit
{
  constructor(
  ...
  static emptyObjectFormFactory(): () => UntypedFormControl {
    return () => {
      return new UntypedFormControl(
        CompanyDocumentItemComponent.createEmptyObject(),
  ...
  public generateForm(value: any): UntypedFormGroup {
    return generateFormFromMetadata(
      ApiCompanyDocument.formMetadata(),
      value,
