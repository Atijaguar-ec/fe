...
import { ApiFacilityTypeValidationScheme } from '../../settings/type-detail-modal/validation';
...
export class ValueChainDetailComponent implements OnInit {
  valueChainDetailForm: UntypedFormGroup;
  ...
  static ApiVCFacilityTypeEmptyObjectFormFactory(): () => UntypedFormControl {
    return () => {
      return new UntypedFormControl(
        ValueChainDetailComponent.ApiVCFacilityTypeCreateEmptyObject(),
  ...
  static ApiVCMeasureUnitTypeEmptyObjectFormFactory(): () => UntypedFormControl {
    return () => {
      return new UntypedFormControl(
        ValueChainDetailComponent.ApiVCMeasureUnitTypeCreateEmptyObject(),
  ...
  static ApiVCProcEvidenceTypeEmptyObjectFormFactory(): () => UntypedFormControl {
    return () => {
      return new UntypedFormControl(
        ValueChainDetailComponent.ApiVCProcEvidenceTypeCreateEmptyObject(),
  ...
  static ApiVCProcEvidenceFieldEmptyObjectFormFactory(): () => UntypedFormControl {
    return () => {
      return new UntypedFormControl(
        ValueChainDetailComponent.ApiVCProcEvidenceFieldCreateEmptyObject(),
  ...
  static ApiVCSemiProductsEmptyObjectFormFactory(): () => UntypedFormControl {
    return () => {
      return new UntypedFormControl(
        ValueChainDetailComponent.ApiVCSemiProductsCreateEmptyObject(),
  ...
  get vcFacilityTypes(): UntypedFormControl[] {
    return (this.valueChainDetailForm.get('facilityTypes') as UntypedFormArray)
      .controls as UntypedFormControl[];
  }

  get vcMeasureUnitTypes(): UntypedFormControl[] {
    return (
      this.valueChainDetailForm.get('measureUnitTypes') as UntypedFormArray
    ).controls as UntypedFormControl[];
  }

  get vcProcEvidenceTypes(): UntypedFormControl[] {
    return (
      this.valueChainDetailForm.get(
        'processingEvidenceTypes',
      ) as UntypedFormArray
    ).controls as UntypedFormControl[];
  }

  get vcProcEvidenceFields(): UntypedFormControl[] {
    return (
      this.valueChainDetailForm.get(
  ...
  get vcSemiProducts(): UntypedFormControl[] {
    return (this.valueChainDetailForm.get('semiProducts') as UntypedFormArray)
      .controls as UntypedFormControl[];
  }
  ...
  ngOnInit(): void {
    ...
    this.productTypeCodebook = new ProductTypesService(
  ...
  public getProductTypeFromControl(): UntypedFormControl {
    return this.valueChainDetailForm.get('productType') as UntypedFormControl;
  }

  private getValueChain() {
    this.globalEventsManager.showLoading(true);
    const id = this.route.snapshot.paramMap.get('id');
    this.valueChainService
      .getValueChain(Number(id))
      .pipe(finalize(() => this.globalEventsManager.showLoading(false)))
      .subscribe((valueChain) => {
        this.valueChainDetailForm = generateFormFromMetadata(
        ...
        if (
          this.mode === 'update' &&
          valueChain.data.valueChainStatus === ValueChainStatusEnum.DISABLED
        ) {
  ...
  private createOrUpdateValueChain(): void {
    this.globalEventsManager.showLoading(true);
    this.valueChainService
      .createOrUpdateValueChain(this.valueChainDetailForm.value)
      .pipe(finalize(() => this.globalEventsManager.showLoading(false)))
      .subscribe((response) => {
  ...
  private initializeListManagers() {
    this.facilityTypeListManager = new ListEditorManager<ApiFacilityType>(
      this.valueChainDetailForm.get('facilityTypes') as UntypedFormArray,
    ...
    this.processingEvidenceTypeListManger =
      new ListEditorManager<ApiProcessingEvidenceType>(
        this.valueChainDetailForm.get(
          'processingEvidenceTypes',
        ) as UntypedFormArray,
    ...
    this.processingEvidenceFieldListManger =
      new ListEditorManager<ApiProcessingEvidenceType>(
        this.valueChainDetailForm.get(
          'processingEvidenceFields',
        ) as UntypedFormArray,
    ...
    this.semiProductsListManager = new ListEditorManager<ApiSemiProduct>(
      this.valueChainDetailForm.get('semiProducts') as UntypedFormArray,
