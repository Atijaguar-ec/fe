...
import {
  ...
  MessageModalService,
} from './message-modal/message-modal.service';
...
export class GlobalEventManagerService {
  private showLoadingSpinnerSubject: BehaviorSubject<boolean> =
    new BehaviorSubject<boolean>(false);
  showLoadingSpinnerEmitter: Observable<boolean> =
    this.showLoadingSpinnerSubject.asObservable();

  private loadedGoogleMapsSubject: BehaviorSubject<boolean> =
    new BehaviorSubject<boolean>(false);
  public loadedGoogleMapsEmitter: Observable<boolean> =
    this.loadedGoogleMapsSubject.asObservable();
  ...
  openMessageModal(
    definition: MessageModalDefinition,
