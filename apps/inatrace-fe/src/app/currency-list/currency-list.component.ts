...
export class CurrencyListComponent implements OnInit {
  ...
  public enabledSortingParam$ = new BehaviorSubject<{
    sortBy: string;
    sort: SortOrder;
  }>({ sortBy: 'code', sort: 'ASC' });
  ...
  public disabledSortingParam$ = new BehaviorSubject<{
    sortBy: string;
    sort: SortOrder;
  }>({ sortBy: 'code', sort: 'ASC' });
  ...
  public enabledSearchText = new UntypedFormControl(null);
  public disabledSearchText = new UntypedFormControl(null);
  ...
  loadCurrencies() {
    this.enabledCurrencyType$ = combineLatest([
      this.enabledSortingParam$,
      this.enabledSearch$,
      this.enabledPagination$,
      this.ping$,
    ]).pipe(
      map(([sorting, search, page]) => {
        return {
          query: search,
          ...sorting,
    ...
    this.disabledCurrencyType$ = combineLatest([
      this.disabledSortingParam$,
      this.disabledSearch$,
