...
@Component({
  ...
  styleUrls: [
    './checklist-add-processing-action-success-modal.component.scss',
    '../self-onboarding-checklist-modal.component.scss',
  ],
  standalone: false,
})
export class ChecklistAddProcessingActionSuccessModalComponent
  implements OnInit
{
  constructor(
