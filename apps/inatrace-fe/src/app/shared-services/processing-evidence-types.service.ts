...
export class ProcessingEvidenceTypeService extends GeneralSifrantService<ApiProcessingEvidenceType> {
  ...
  public makeQuery(
    ...
    params?: any,
    productId?: string,
  ): Observable<PagedSearchResults<ApiProcessingEvidenceType>> {
    ...
    return this.fetchProcessingEvidenceTypes(
      reqPars,
  ...
  private fetchProcessingEvidenceTypes(
    reqParams,
    valueChainIdList?: Array<number>,
  ): Observable<ApiPaginatedResponseApiProcessingEvidenceType> {
    if (valueChainIdList !== null && valueChainIdList !== undefined) {
      return this.codebookService.listProcessingEvidenceTypesByValueChainsByMap(
