...
import {
  FinalProductControllerService,
  GetFinalProductsForCompany,
} from '../../api/api/finalProductController.service';
...
export class FinalProductsForCompanyService extends GeneralSifrantService<ApiFinalProduct> {
  ...
  makeQuery(
    key: string,
    params?: any,
  ): Observable<PagedSearchResults<ApiFinalProduct>> {
    ...
    return this.finalProductController
      .getFinalProductsForCompanyByMap(reqParams)
      .pipe(
