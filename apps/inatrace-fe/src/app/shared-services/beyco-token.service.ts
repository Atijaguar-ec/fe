...
export class BeycoTokenService {
  ...
  public tokenAvailable$: BehaviorSubject<boolean> =
  ...
  private refreshToken() {
    return this.beycoService
      .refreshToken(this.beycoToken.refreshToken, this.companyId)
      .pipe(
        tap((resp) => {
