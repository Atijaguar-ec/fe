...
export class EnumSifrant extends GeneralSifrantService<ApiEnumWithLabelString> {
  ...
  public makeQuery(
    key: string,
    params?: any,
  ): Observable<PagedSearchResults<ApiEnumWithLabelString>> {
  ...
  public initializeEnumOptions() {
    this.sifrant$.subscribe(
      (val: PagedSearchResults<ApiEnumWithLabelString>) => {
  ...
  public enumValueToObject(
    val: any,
    enumOptions: ApiEnumWithLabelString[],
