...
} from '../../api/api/productTypeController.service';

@Injectable({
  providedIn: 'root',
})
export class ProductTypesService extends GeneralSifrantService<ApiProductType> {
  constructor(private codebookService: ProductTypeControllerService) {
    super();
  }
  ...
  public makeQuery(
    key: string,
    params?: any,
  ): Observable<PagedSearchResults<ApiProductType>> {
