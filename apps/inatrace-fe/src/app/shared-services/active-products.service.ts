...
} from 'src/api/api/productController.service';
...
export class ActiveProductsService extends GeneralSifrantService<ApiProductListResponse> {
  constructor(private producController: ProductControllerService) {
    super();
  }
  ...
  public makeQuery(
    key: string,
    params?: any,
  ): Observable<PagedSearchResults<ApiProductListResponse>> {
    // console.log("MAKE Q")
