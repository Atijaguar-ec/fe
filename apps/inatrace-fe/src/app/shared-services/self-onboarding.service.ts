...
export class SelfOnboardingService {
  public addProductCurrentStep$: Subject<number | string | null> =
    new BehaviorSubject<number | string | null>(null);
  public addFacilityCurrentStep$: Subject<number | string | null> =
    new BehaviorSubject<number | string | null>(null);
  public addProcessingActionCurrentStep$: Subject<number | string | null> =
    new BehaviorSubject<number | string | null>(null);
  public addFarmersCurrentStep$: Subject<number | string | null> =
    new BehaviorSubject<number | string | null>(null);

  public guidedTourStep$: Subject<number | string | null> = new BehaviorSubject<
    number | string | null
  >(null);
