...
export class KnowledgeBlogSelectSectionModalComponent implements OnInit {
  ...
  get statusList() {
    let obj = {};
    obj['FAIRNESS'] =
      $localize`:@@productLabelFrontFeedback.statusList.fairness:Fairness`;
    obj['QUALITY'] =
      $localize`:@@productLabelFrontFeedback.statusList.quality:Quality`;
    obj['PROVENANCE'] =
      $localize`:@@productLabelFrontFeedback.statusList.provenance:Provenance`;
    return obj;
  }
