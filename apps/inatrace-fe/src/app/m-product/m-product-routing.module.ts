...
const routes: Routes = [
  ...
  {
    path: ':id/knowledge-blog',
    loadChildren: () =>
      import('./knowledge-blog/knowledge-block.module').then(
        (m) => m.KnowledgeBlockModule,
      ),
  },
  {
    path: ':id/stakeholders',
    loadChildren: () =>
      import('./product-stakeholders/product-stakeholders.module').then(
        (m) => m.ProductStakeholdersModule,
      ),
  },
  {
    path: ':id/final-products',
    loadChildren: () =>
      import('./product-final-product/product-final-product.module').then(
        (m) => m.ProductFinalProductModule,
      ),
  },
  {
