...
export class StakeholdersValueChainComponent
  extends ProductLabelStakeholdersComponent
  implements OnInit
{
  rootTab = 0;
  ...
  get dataSharingAgreementsControls(): AbstractControl[] {
    return (this.productForm.get('dataSharingAgreements') as UntypedFormArray)
      .controls;
  }
