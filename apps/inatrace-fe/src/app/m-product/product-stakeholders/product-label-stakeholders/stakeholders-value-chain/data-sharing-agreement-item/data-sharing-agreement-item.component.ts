...
export class DataSharingAgreementItemComponent
  extends GenericEditableItemComponent<ApiProductDataSharingAgreement>
  implements OnInit
{
  @Input()
  disableDelete = false;
  ...
  public generateForm(value: any): UntypedFormGroup {
    return generateFormFromMetadata(
      ApiProductDataSharingAgreement.formMetadata(),
      value,
